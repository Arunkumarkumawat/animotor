...
CREATE TABLE `insurance_coverages` (
  ...
  `coverage_matrix` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `what_not_covered` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  `documents` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `customer_instruction` longtext DEFAULT NULL,
  `claims_contact` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
...
# Dump of table rh_bookings
# ------------------------------------------------------------

DROP TABLE IF EXISTS `rh_bookings`;
...
CREATE TABLE `rh_bookings` (
  ...
  `curr_pricing_data` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`curr_pricing_data`)),
...
LOCK TABLES `rh_bookings` WRITE;
/*!40000 ALTER TABLE `rh_bookings` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `rh_bookings` ENABLE KEYS */;
UNLOCK TABLES;
