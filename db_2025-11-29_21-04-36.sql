...
# Database: db
# Generation time: 2025-11-29T21:04:38+05:30
# ************************************************************
...
INSERT INTO `insurance_coverages` (`id`, `policy_number`, `insurer_name`, `policy_start_date`, `policy_end_date`, `vehicle_classes`, `insurer_logo`, `coverage_matrix`, `what_not_covered`, `key_exclusions`, `excess_amount`, `max_claim_limit`, `daily_rate`, `documents`, `customer_instruction`, `claims_contact`, `required_documents`, `status`, `company_id`, `policy_type`, `created_at`, `updated_at`) VALUES
	...
	(5, "asdfsadf", "asadfasdf", "2025-11-28", "2025-11-29", "[\"economy\",\"compact\",\"suv\"]", "insurance-coverages/9SXrn21gRLYJKHaQsPrbkQYbkfg6r27Lk5i8muZv.jpg", "[{\"name\":\"Tyre & Wheel Damage\",\"status\":\"covered\",\"partial_notes\":null},{\"name\":\"Glass Damage (Full Coverage)\",\"status\":\"partial\",\"partial_notes\":\"asdfas\"},{\"name\":\"Lost or Stolen Keys\",\"status\":\"not\",\"partial_notes\":null},{\"name\":\"24\\/7 Roadside Assistance\",\"status\":\"covered\",\"partial_notes\":null},{\"name\":\"Breakdown Recovery & Towing\",\"status\":\"partial\",\"partial_notes\":\"afdsfa\"},{\"name\":\"Underbody Damage\",\"status\":\"not\",\"partial_notes\":\"Covers sump & exhaust damage\"},{\"name\":\"Roof Damage\",\"status\":\"covered\",\"partial_notes\":null},{\"name\":\"Child Seats \\/ Booster Seats\",\"status\":\"partial\",\"partial_notes\":\"dfa\"},{\"name\":\"GPS \\/ Sat Nav Device\",\"status\":\"not\",\"partial_notes\":null},{\"name\":\"Additional Driver Coverage\",\"status\":\"covered\",\"partial_notes\":null}]", "[\"Wear and tear on tyres\",\"Pre-existing damage to glass\",\"Keys left inside vehicle (theft)\"]", "sdfasdfadsfasdfsadf", 35, 555, 445, "{\"policy_schedule\":\"insurance-coverages\\/eJumTaVgFZMiOmd80kmZrStJpDnYhmMVzkiotsfs.pdf\",\"terms_and_conditions\":\"insurance-coverages\\/Bjjx6p51wyUUKO5jlqjuP7HMKqlzDq809WzjPk2a.pdf\",\"ipid\":\"insurance-coverages\\/IVHsZDAUfrMLJUo8kLaAhx6cCeZQBCHQ5Gd3ams9.pdf\",\"insurer_certificate\":\"insurance-coverages\\/NUqit0L1zLN8ZydyvaAhXcBpHziZyBosmWLZGuYP.pdf\"}", "asdfasdf", "{\"email\":\"adsfasd@addsfasdf.sdf\",\"phone_main\":\"234324234\",\"phone_roadside\":\"4234324234\",\"address\":\"asdfasfa\",\"portal_url\":\"https:\\/\\/animotor.ddev.site\"}", "[\"Rental Agreement showing add-on(s) purchased\",\"Photos of damage (tyres, glass, roof, underbody)\",\"Inspection report (for tyre\\/glass claims)\"]", "Active", "a060e33d-b592-4617-a50b-0b31f5db915f", "Addons", "2025-11-28 09:32:20", "2025-11-28 09:38:06");
...
# Dump completed on 2025-11-29T21:04:39+05:30
