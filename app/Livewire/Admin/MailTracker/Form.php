...
//        dd($this->mail_tracker, $this->mailTrackerId);
        ...
        auth()->user()->activityLog('Mail Tracker created.', [
            'reference_no' => $tracker->reference_no,
            'type' => $tracker->type,
    ...
    public function saveDetails()
    {
        ...
        auth()->user()->activityLog('Mail Tracker updated.', [
            'reference_no' => $mailTracker->reference_no,
            'type' => $mailTracker->type,
            'status' => $mailTracker->status,
        ]);
