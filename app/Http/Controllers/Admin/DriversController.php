...
//        $driver = User::findOrFail($driverId);
     ...
     public function storeDriver(Request $request)
    {
        ...
        $user->activityLog('New Driver created.', ['driver_name' => $user->first_name.' '.$user->last_name]);
    ...
    public function deleteDriver($driverId)
    {
        ...
        $driver->activityLog('Driver deleted.', ['driver_name' => $driver->first_name.' '.$driver->last_name]);
    ...
    public function driverStatus(Request $request, $driverId)
    {
        ...
        $driver->activityLog('Driver status updated.', ['driver_name' => $driver->first_name.' '.$driver->last_name]);
