<div class="carferrari__item mb__30 car_item d-flex  bgwhite p-3 {{ isset($is_highlighted) && $is_highlighted ? 'highlighted-car' : '' }}"
    ...
    <div class="d-flex p__10 align-items-center car_section">
        ...
        <div class="carferrari__content">
            <div class="d-flex- carferari__box justify-content-between">
                ...
                <div class="row">
                    <div class="col-12">
                        <h5 class=" text-truncate pb-3" style="border-bottom: 1px solid rgba(167, 164, 156, 0.59); font-weight:normal;"><span class="text-title">{{ $car->title }} </span>or similar car</h5>
                    </div>
                    ...
                    <div class="col-6 mt-3">
                        <p><img src="/assets/img/icons/bag.png" />
                            {{ $car?->bags ? $car?->bags . ' Bags' : 'Not allowed' }}</p>
                    </div>
                    ...
                    <div class="col-6 mt-3">
                        <p class="text-primary text-truncate"><a href="">Pickup Location :
                                {{ $car?->pick_up_location ?? 'Pick-up Not set' }}</a></p>
            ...
            <div class="mt-3">
                ...
                <div class="col-12 d-flex justify-content-between mt-3 p-3">
                    <div>
                    ...
                    <div class="car-details mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <p><strong>Total for {{ $days }} day(s):</strong>
                                    {{ amt($car->price_per_day * $days) }}</p>
                            </div>
                        </div>
                    </div>
