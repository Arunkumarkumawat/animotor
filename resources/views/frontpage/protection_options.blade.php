                ...
                <div class="d-flex booking_stage align-items-center justify-content-between">
                    ...
                    <div class="">
                        <a href="javascript:void(0)" class="cmn__btn">
                            <img class="text-white" src="/assets/img/icons/shield.png"><span class="mx-3">Protection
                                option</span>
                        </a>
                    </div>
                    <div class=" d-none d-md-block">
            ...
            <div class="row g-4 justify-content-center mt-3">
                <div class="col-xxl-8 col-xl-8 col-lg-8">
                        ...
                        <div class="qustion__content">
                            ...
                            <div class="accordion__wrap">
                                <div class="accordion" id="accordionExample">
                                    ...
                                    <div class="p-3">
                                        <div>
                                            <p class="text-heading mb-2">Protection... <span class="text-success">for peace
                                                    of mind</span></p>
                                            <p class="mb-2">At the rental counter, the car hire company will place a hold
                                                on your credit card for the security deposit. If the car is damaged or
                                                stolen, you could lose this deposit — but with our Full Protection,
                                                Rentalcover.com will reimburse you in full. (The price shown already
                                                includes all taxes and fees.)</p>
                                            <p class="mb-2">Terms & Conditions and standard exclusions apply. Please
                                                review carefully:</p>
                                            <p class="mb-2"><a href="#" class="text-decoration-none">Protection
                                                    terms</a></p>
                                        </div>
                                        <div class="mt-3">
                                        ...
                                        <div class="d-flex justify-content-between mt-4 row">
                                            ...
                                            @foreach ($insurance_data as $index => $coverage)
                                                @php
                                                    $policy = \App\Models\InsuranceCoverage::where(
                                                        'id',
                                                        $coverage['policy_id'],
                                                    )->first();
                                                @endphp
                                                <div class="row border-bottom py-4">
                                                    ...
                                                    <div class="col-2 text-center">
                                                        <p style="margin-top:5px;">
                                                            {{ amt($coverage['daily_price'] ? $coverage['daily_price'] : $policy->daily_rate) }}
                                                        </p>
                                                    </div>
                                                    <div class="col-2 text-center">
                                                        <p style="margin-top:5px;">
                                                            {{ amt($coverage['excess'] ? $coverage['excess'] : $policy->excess) }}
                                                        </p>
                                                    </div>
                                                    <div class="col-2">
                                                        <a href="{{ url('checkout') }}?{{ http_build_query(['book_type' => 'with_full_protection', 'insurance_id' => $index] + request()->query()) }}"
                                                            class="cmn__btn" style="padding:5px 14px; font-size:16px;">
                                                            <span>
                                                                Add
                                                            </span>
                                                        </a>
                    ...
                    <div class="alert alert-danger">
                        <b>Please note:</b> Your own car insurance is unlikely to cover hire cars. All refunds are subject
                        to T&Cs and standard exclusions.
                    </div>

                    <div class="justify-content-center d-flex gap-4 text-center">
                        <div>
                            <p>Without <br />Full Protection</p>
                            <a href="{{ url('checkout') }}?{{ http_build_query(['book_type' => 'without_full_protection'] + request()->query()) }}"
                                class="cmn_btn_white">
                                <span>
                                    Go to book
                                </span>
                    ...
                    <div class="dating__body text-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col text-center ps-5 ">
                                <div class="input">
                                    <p class="px-3 text-center">exampls@gmail.com <span> <button
                                                class=" ms-5 btn btn_style">Subscribe</button></span></p>
                                </div>
                            </div>
                            <div class="col"></div>
                        </div>
