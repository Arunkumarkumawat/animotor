...
@section('content')
    ...
    <div class="container page-container py-4">
        ...
        <div class="reference-card">
            ...
            <div class="reference-code">CH-0480O34A6</div>
            <div class="reference-note">A confirmation email has been sent to</div>
        </div>
            ...
            <div class="card-body pt-0 pb-2">
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="detail-value">+44 7700 900123</div>
                    </div>
                    <div class="col-md-4">
                        <div class="detail-label">Date &amp; Time</div>
                        <div class="detail-value">Friday 28 November 2025</div>
                        <div class="helper-text">09:00</div>
                    </div>
                    <div class="col-md-2 d-flex align-items-center">
                        <span class="badge-pill">HOURLY</span>
                    </div>
                </div>
                ...
                <div class="detail-value">London Heathrow Airport, Terminal 5</div>
            </div>
        </div>
            ...
            <div class="card-body pt-0">
                ...
                <div class="d-flex align-items-center mb-3">
                    <img src="https://images.pexels.com/photos/614810/pexels-photo-614810.jpeg?auto=compress&cs=tinysrgb&w=200"
                        alt="Driver" class="profile-avatar">
                    <div>
                        <div class="detail-value mb-0">James Anderson</div>
                        <div class="driver-role">Professional Chauffeur · 12 years experience</div>
                        <div class="mt-1">
                ...
                <div class="d-flex align-items-center">
                    <img src="https://images.pexels.com/photos/210019/pexels-photo-210019.jpeg?auto=compress&cs=tinysrgb&w=400"
                        alt="Car" class="vehicle-img">
                    <div>
                        <div class="detail-value mb-0">Mercedes-Benz S-Class</div>
                        <div class="helper-text">Executive Saloon · 2023</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card card-shell mb-4">
            ...
            <div class="card-body pt-0">
                ...
                <div class="summary-note">
                    Remaining balance due before journey
                </div>
            </div>
        </div>
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-md-6">
                <button class="btn btn-outline-dark-custom w-100">
                    <i class="far fa-calendar-alt me-2"></i>Add to Calendar
                </button>
            </div>
        </div>
        ...
        <div class="row g-3 pb-4">
            <div class="col-md-6">
                <button class="btn btn-outline-dark-custom w-100">Back to Home</button>
            </div>
            <div class="col-md-6">
                <button class="btn btn-primary-custom w-100">Book Another Chauffeur</button>
            </div>
        </div>
    </div>
@endsection
