                            ...
                            <div class="card-inner card-inner-lg">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input value="{{ old('first_name') }}" type="text" name="first_name"
                                                class="form-control @error('first_name') error @enderror form-control-lg"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input value="{{ old('last_name') }}" type="text" name="last_name"
                                                class="form-control @error('last_name') error @enderror form-control-lg"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input value="{{ old('email') }}" type="email" name="email"
                                                class="form-control @error('email') error @enderror form-control-lg"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input value="{{ old('phone') }}" type="tel" name="phone"
                                                class="form-control @error('phone') error @enderror form-control-lg"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            ...
                                            <input type="password" name="password"
                                                class="form-control @error('password') error @enderror  form-control-lg"
                                ...
                                <div class="form-note-s2 text-center pt-4">
                                    ...
                                    <a href="/login" class="btn btn-sm btn-primary">Sign In</a>
                                     <p>OR</p>
                                    <a href="/company-signup" class="btn btn-sm btn-primary">Register as
                                        Company</a>
                                        </div>
