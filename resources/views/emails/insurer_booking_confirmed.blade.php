...
<span style="display:none; font-size:1px; color:#ffffff; line-height:1px; max-height:0; max-width:0; opacity:0; overflow:hidden;">
  A new standard booking has been confirmed.
</span>
...
<head>
  ...
  <title>New standard Booking confirmed – {{ $booking->id }}</title>
</head>
                ...
                <tr>
                  <td>
                    ...
                    <div style="margin-top:6px; font-size:13px; color:#e8f3ff;">
                      New standard booking confirmed
                    </div>
                  </td>
          ...
          <tr>
            <td style="padding:24px 28px 12px;">
              ...
              <p style="margin:0 0 18px; font-size:15px;">
                A new standard booking has booked an insurance policy and is waiting for your action.
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" role="presentation" 
                ...
                <tr>
                  <td style="padding:6px 8px; font-size:14px; color:#444;">
                    ...
                    @if($booking->booking_type == 'with_full_protection')
                      @php 
                        $policy = \App\Models\Policy::where('id', $booking->policy_id)->first();
                      @endphp
                      @if($policy)
                        <strong>Protection Plan:</strong> {{ $policy->policy_number }}<br>
                      @endif
                    @endif
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td>
                    ...
                    <div style="margin-top:6px;">Booking Reference: {{ $booking->reference }}</div>
                  </td>
