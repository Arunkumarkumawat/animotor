...
<table width="700" cellpadding="0" cellspacing="0" 
      ...
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td style="text-align:right; vertical-align:middle;">
            <div style="width:48px; height:48px; border-radius:8px; background:rgba(255,255,255,0.14); 
                        display:inline-block; line-height:48px; text-align:center; font-size:22px;">
              🧾
            </div>
          </td>
        </tr>
  ...
  <tr>
    <td style="padding:24px 28px 12px;">
      ...
      <p style="margin:0 0 18px; font-size:15px;">
        Refund action is required for the following booking.
      </p>
  ...
  <!-- FOOTER -->
  <tr>
    <td style="padding:18px 28px 26px; border-top:1px solid #eef1f5; 
