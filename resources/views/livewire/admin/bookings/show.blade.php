        ...
        <div class="nk-block-between g-3">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title"> <strong
                        class="text-primary small">{{ $booking->reference }}</strong></h3>
                <div class="nk-block-des text-soft">
                    <ul class="list-inline">
                        <li>{{ __('admin.booked_on') }} : <span
                                class="text-base">{{ $booking->created_at->format('d-M-Y H:i:s') }}</span></li>
                    </ul>
    ...
    <div class="nk-block">
        <div class="card card-bordered">
            <div class="card-aside-wrap">
                <div class="card-aside card-aside-left user-aside toggle-slide toggle-slide-left toggle-break-md"
                    data-content="userAside" data-toggle-screen="md" data-toggle-overlay="true" data-toggle-body="true">
                    <div class="card-inner-group" data-simplebar>
                        <div class="card-inner">
                            ...
                            <div class="user-card user-card-s2">
                                ...
                                <div class="user-info">
                                    <div class="badge bg-outline-light rounded-pill ucap">{{ __('admin.customer') }}
                                    </div>
                                    ...
                                    <div class="profile-balance-sub">
                                        @if (!$booking->cancelled && !$booking->completed)
                                            <div class="profile-balance-amount">
                                                <form method="POST"
                                                    action="{{ route('admin.bookings.update_status') }}"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="form-label"
                                                                for="fuel_type">{{ __('admin.booking_status') }}</label>
                                                        ...
                                                        @include('admin.partials.form.select_array', [
                                                            'attributes' => 'required',
                                                            'colSize' => 'col-md-12 mt-3_',
                                                            'value' => $booking->picked,
                                                            'fieldName' => 'picked',
                                                            'title' => __('admin.vehicle_picked'),
                                                            'options' => ['yes', 'no'],
                                                        ])
                                                        @include('admin.partials.form.select_array', [
                                                            'attributes' => 'required',
                                                            'colSize' => 'col-md-12 mt-3',
                                                            'value' => 'no',
                                                            'fieldName' => 'notify_customer',
                                                            'title' => __('admin.notify_customer'),
                                                            'options' => ['yes', 'no'],
                                                        ])

                                                        @include('admin.partials.form.textarea', [
                                                            'colSize' => 'col-md-12 mt-3 mb-3',
                                                            'value' => $booking->comment,
                                                            'fieldName' => 'comment',
                                                            'title' => __('admin.status_comment'),
                                                        ])


                                                        <div class="form-group mt-3">
                                                            <button type="submit"
                                                                class="btn btn-lg btn-primary">{{ __('admin.update') }}</button>
                                                        </div>
                    ...
                    <ul class="nav nav-tabs nav-tabs-mb-icon nav-tabs-card">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab"
                                href="#info"><span>{{ __('admin.other_details') }}</span></a>
                        </li>
                                ...
                                <div class="nk-block">
                                    ...
                                    <div class="profile-ud-list">
                                        ...
                                        <div class="profile-ud-item">
                                            <div class="profile-ud wider">
                                                ...
                                                <span
                                                    class="profile-ud-value">{{ $booking?->region?->name ?? __('admin.not_set') }}</span>
                                            </div>
                                        </div>

                                    </div><!-- .profile-ud-list -->

                                    @if($booking->billing_details)
                                    <div class="nk-block-head mt-4 mb-3">
                                        <h5 class="title">{{ __('admin.billing_details') }}</h5>
                                    </div><!-- .nk-block-head -->
                                    <div class="profile-ud-list">
                                        <div class="profile-ud-item">
                                            <div class="profile-ud wider">
                                                <span class="profile-ud-label">{{ __('admin.full_name') }}</span>
                                                <span class="profile-ud-value">{{ $booking->billing_details['first_name'] . ' ' . $booking->billing_details['last_name'] }}</span>
                                            </div>
                                        </div>
                                        <div class="profile-ud-item">
                                            <div class="profile-ud wider">
                                                <span class="profile-ud-label">{{ __('admin.phone') }}</span>
                                                <span class="profile-ud-value">{{ $booking->billing_details['phone'] }}</span>
                                            </div>
                                        </div>
                                        <div class="profile-ud-item">
                                            <div class="profile-ud wider">
                                                <span class="profile-ud-label">{{ __('admin.address') }}</span>
                                                <span
                                                    class="profile-ud-value">{{ $booking?->billing_details['address'] ?? __('admin.not_set') }}</span>
                                            </div>
                                        </div>
                                        <div class="profile-ud-item">
                                            <div class="profile-ud wider">
                                                <span class="profile-ud-label">{{ __('admin.city') }}</span>
                                                <span
                                                    class="profile-ud-value">{{ $booking?->billing_details['city'] ?? __('admin.not_set') }}</span>
                                            </div>
                                        </div>
                                        <div class="profile-ud-item">
                                            <div class="profile-ud wider">
                                                <span class="profile-ud-label">{{ __('admin.zipcode') }}</span>
                                                <span
                                                    class="profile-ud-value">{{ $booking?->billing_details['zipcode'] ?? __('admin.not_set') }}</span>
                                            </div>
                                        </div>
                                        <div class="profile-ud-item">
                                            <div class="profile-ud wider">
                                                <span class="profile-ud-label">{{ __('admin.country') }}</span>
                                                <span
                                                    class="profile-ud-value">{{ $booking?->billing_details['country'] ?? __('admin.not_set') }}</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="carferrari__item mb__30 car_item d-flex-  bgwhite p-3">
                                        ...
                                        <div style="border-bottom: 0"
                                            class="row d-flex p__10 align-items-center car_section">
                                            ...
                                            <div class="carferrari__content col-md-6 col-sm-12">
                                                <div class="d-flex- carferari__box justify-content-between">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <p><span class="text-title">{{ $booking->car->title }}
                                                                </span>or similar car</p>
                                                        </div>
                                                        ...
                                                        <div class="col-6 mt-3">
                                                            <p class="text-primary">
                                                                {{ $booking->car?->pick_up_location ?? 'Pick-up Not set' }}
                                                            </p>
                                    ...
                                    <div class="profile-ud-list">
                                        ...
                                        <div class="profile-ud-item">
                                            ...
                                            <div class="profile-ud wider">
                                                ...
                                                <span
                                                    class="profile-ud-value">{{ amt($booking->insurance_fee) }}</span>
                                            </div>
                                            <div class="profile-ud wider">
                                                <span class="profile-ud-label">{{ __('admin.commission') }}</span>
                                                <span class="profile-ud-value">{{ amt($booking->commission) }}</span>
                                            </div>
                                            <div class="profile-ud wider">
