        ...
        <div class="col-lg-12">
            <div class="card card-bordered- h-100">
                <div class="card-inner">
                        ...
                        <div class="container">
                            ...
                            @if ($step == 1)
                                <div wire:key="1" class="row mt-3">
                                            ...
                                            <div class="form-control-wrap">
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input" id="top_pick"
                                                        wire:model.live="top_pick" style="width: 3em; height: 1.5em;">
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            <label class="form-label-outlined-" for="ideal_for_family">Ideal for
                                                Family</label>
                                            <div class="form-control-wrap">
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input"
                                                        id="ideal_for_family" wire:model.live="ideal_for_family"
                                                        style="width: 3em; height: 1.5em;">
                                                    <label class="form-check-label ms-2" for="ideal_for_family">
                                                        {{ $ideal_for_family ? 'Yes' : 'No' }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            <label class="form-label-outlined-" for="free_cancellation">Free
                                                cancellation up to 24 hours before pick-up</label>
                                            <div class="form-control-wrap">
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input"
                                                        id="free_cancellation" wire:model.live="free_cancellation"
                                                        style="width: 3em; height: 1.5em;">
                                                    <label class="form-check-label ms-2" for="free_cancellation">
                                                        {{ $free_cancellation ? 'Yes' : 'No' }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            <label class="form-label-outlined-" for="collision_damage_waiver">Collision
                                                Damage Waiver</label>
                                            <div class="form-control-wrap">
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input"
                                                    ...
                                                    <label class="form-check-label ms-2" for="collision_damage_waiver">
                                                        {{ $collision_damage_waiver ? 'Yes' : 'No' }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            <label class="form-label-outlined-" for="theft_protection">Theft
                                                Protection</label>
                                            <div class="form-control-wrap">
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input"
                                                        id="theft_protection" wire:model.live="theft_protection"
                                                        style="width: 3em; height: 1.5em;">
                                                    <label class="form-check-label ms-2" for="theft_protection">
                                                        {{ $theft_protection ? 'Yes' : 'No' }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            <label class="form-label-outlined-" for="unlimited_mileage">Unlimited
                                                mileage</label>
                                            <div class="form-control-wrap">
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input"
                                                        id="unlimited_mileage" wire:model.live="unlimited_mileage"
                                                        style="width: 3em; height: 1.5em;">
                                                    <label class="form-check-label ms-2" for="unlimited_mileage">
                                                        {{ $unlimited_mileage ? 'Yes' : 'No' }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            <label class="form-label-outlined-" for="private_hire">Private
                                                Hire</label>
                                            <div class="form-control-wrap">
                                                <div class="form-check form-switch">
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            <label class="form-label-outlined-" for="chauffeur">Chauffeur</label>
                                            <div class="form-control-wrap">
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input" id="chauffeur"
                                                        wire:model.live="chauffeur"
                                                        wire:change="updateChauffeur($event.target.checked ? 1 : 0)"
                                                        style="width: 3em; height: 1.5em;">
                                                    <label class="form-check-label ms-2" for="chauffeur">
                                                        {{ $chauffeur ? 'Yes' : 'No' }}
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-12 mt-3">
                                        <div class="form-group">
                                            <label class="form-label" for="description">Vehicle Description (Max
                                                Characters: 200)</label>
                                            <div class="form-control-wrap">
                                                <textarea class="form-control form-control-lg" id="description" wire:model="description"
                                                    placeholder="Vehicle description" maxlength="200"></textarea>
                                                @error('description')
                                                    <span class="invalid">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="col-md-4 mt-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" min="1"
                                                        wire:model.live="hourly_rate" name="hourly_rate"
                                                        class="form-control form-control-lg" data-ui="xl"
                                                        id="hourly_rate" pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                        step="0.01" maxlength="20">
                                                </div>
                                            </div>
                                            <div class="col-md-4 mt-3">
                                                <div class="form-group">
                                                    <div for="p2p_rate" class="d-flex justify-content-between">
                                                        <div>P2P Rate {{ settings('currency_symbol', '$') }}</div>
                                                        <div>
                                                            <div class="form-control-wrap">
                                                                <div class="form-check form-switch">
                                                                    <input type="checkbox" class="form-check-input"
                                                                        id="p2p_rate_tax_incl"
                                                                        wire:model.live="p2p_rate_tax_incl"
                                                                        style="width: 3em; height: 1.5em; margin-top : -1px"
                                                                        disabled>
                                                                    <label class="form-check-label ms-2"
                                                                        for="p2p_rate_tax_incl">
                                                                        {{ $p2p_rate_tax_incl ? 'Tax Included' : 'Tax Excluded' }}
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <input type="text" min="1"
                                                        wire:model.live="p2p_rate" name="p2p_rate"
                                                        class="form-control form-control-lg" data-ui="xl"
                                                        id="p2p_rate" pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                        step="0.01" maxlength="20">
                                                </div>
                                            </div>
                                            <div class="col-md-4 mt-3">
                                                <div class="form-group">
                                                    <div for="airport_transfer_rate"
                                                        class="d-flex justify-content-between">
                                                        <div>Airport Transfer {{ settings('currency_symbol', '$') }}
                                                        </div>
                                                        <div>
                                                            <div class="form-control-wrap">
                                                                <div class="form-check form-switch">
                                                                    <input type="checkbox" class="form-check-input"
                                                                        id="airport_transfer_rate_tax_incl"
                                                                        wire:model.live="airport_transfer_rate_tax_incl"
                                                                        style="width: 3em; height: 1.5em; margin-top : -1px"
                                                                        disabled>
                                                                    <label class="form-check-label ms-2"
                                                                        for="airport_transfer_rate_tax_incl">
                                                    ...
                                                    <input type="text" min="1"
                                                        wire:model.live="airport_transfer_rate"
                                                        name="airport_transfer_rate"
                                                        class="form-control form-control-lg" data-ui="xl"
                                                        id="airport_transfer_rate" pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                        step="0.01" maxlength="20">
                                                </div>
                                            </div>
                                            <div class="col-md-4 mt-3">
                                                <div class="form-group">
                                                    <div for="long_transfer_rate"
                                                        class="d-flex justify-content-between">
                                                        ...
                                                        <div>
                                                            <div class="form-control-wrap">
                                                                <div class="form-check form-switch">
                                                                    <input type="checkbox" class="form-check-input"
                                                                        id="long_transfer_rate_tax_incl"
                                                                        wire:model.live="long_transfer_rate_tax_incl"
                                                                        style="width: 3em; height: 1.5em; margin-top : -1px"
                                                                        disabled>
                                                                    <label class="form-check-label ms-2"
                                                                        for="long_transfer_rate_tax_incl">
                                                    ...
                                                    <input type="text" min="1"
                                                        wire:model.live="long_transfer_rate" name="long_transfer_rate"
                                                        class="form-control form-control-lg" data-ui="xl"
                                                        id="long_transfer_rate" pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                        step="0.01" maxlength="20">
                                                </div>
                                            </div>
                                            <div class="col-md-4 mt-3">
                                                <div class="form-group">
                                                    ...
                                                    <div for="event_hire_rate" class="d-flex justify-content-between">
                                                        ...
                                                        <div>
                                                            <div class="form-control-wrap">
                                                                <div class="form-check form-switch">
                                                                    <input type="checkbox" class="form-check-input"
                                                                        id="event_hire_rate_tax_incl"
                                                                        wire:model.live="event_hire_rate_tax_incl"
                                                                        style="width: 3em; height: 1.5em; margin-top : -1px"
                                                                        disabled>
                                                                    <label class="form-check-label ms-2"
                                                                        for="event_hire_rate_tax_incl">
                                                    ...
                                                    <input type="text" min="1"
                                                        wire:model.live="event_hire_rate" name="event_hire_rate"
                                                        class="form-control form-control-lg" data-ui="xl"
                                                        id="event_hire_rate" pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                        step="0.01" maxlength="20">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    @if ($private_hire)
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mt-2">
                                                <div class="form-group">
                                                    <label class="form-label" for="private_hire">Licensing
                                                        Authority</label>
                                                    <select class="form-control" name="licensing_authority"
                                                        wire:model="licensing_authority">
                                                        <option value="">Select Licensing Authority</option>
                                                        <option value="Transport for London">Transport for London
                                                        </option>
                                                        <option value="Manchester City Council">Manchester City Council
                                                        </option>
                                                        <option value="Birmingham City Council">Birmingham City Council
                                                        </option>
                                                        <option value="Leeds City Council">Leeds City Council</option>
                                                        <option value="Liverpool City Council">Liverpool City Council
                                                        </option>
                                                        <option value="Newcastle City Council">Newcastle City Council
                                                        </option>
                                                        <option value="Nottingham City Council">Nottingham City Council
                                                        </option>
                                                        <option value="Salford City Council">Salford City Council
                                                        </option>
                                                        <option value="Sheffield City Council">Sheffield City Council
                                                        </option>
                                                        <option value="West Midlands City Council">West Midlands City
                                                            Council</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-4 mt-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" wire:model="phv_plate_number"
                                                        pattern="^[A-Za-z0-9]{4,20}$" class="form-control"
                                                        placeholder="PHV Plate Number" maxlength="20">
                                                </div>
                                            </div>
                                            <div class="col-md-4 mt-2">
                                                <div class="form-group" wire:ignore>
                                                    ...
                                                    <input type="text" data-type="date"
                                                        wire:model="phv_expiry_date" class="form-control flatpickr"
                                            ...
                                            <div class="col-md-4 mt-2">
                                                <div class="form-group" wire:ignore>
                                                    ...
                                                    <input type="text" data-type="date"
                                                        wire:model="hr_insurance_expiry"
                                            ...
                                            <div class="col-md-4 mt-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" wire:model="plate_certificate_input"
                                                        class="form-control" placeholder="Plate Certificate">
                                                    @if ($plate_certificate)
                                                        <a href="{{ $plate_certificate }}" target="_blank">View Plate
                                                            Certificate</a>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-md-4 mt-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" wire:model="hr_insurance_proof_input"
                                                        class="form-control" placeholder="H&R Insurance Proof">
                                                    @if ($hr_insurance_proof)
                                                        <a href="{{ $hr_insurance_proof }}" target="_blank">View H&R
                                                            Insurance Proof</a>
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mt-2">
                                                <div class="form-group">
                                                    <label>
                                                        <input type="checkbox" wire:model="short_term" value="1"
                                                            wire:change="updateData('short_term', $event.target.checked)">
                                                        Short Term Flexible
                                                    </label>
                                                    <p>1 week - 3 months</p>
                                                </div>
                                            ...
                                            <div class="col-md-4 mt-2">
                                                <div class="form-group">
                                                    <label>
                                                        <input type="checkbox" wire:model="long_term" value="1"
                                                            wire:change="updateData('long_term', $event.target.checked)">
                                                        Long Term
                                                    </label>
                                                    <p>3 months+</p>
                                                </div>
                                            ...
                                            <div class="col-md-4 mt-2">
                                                <div class="form-group">
                                                    <label>
                                                        <input type="checkbox" wire:model="rent_to_buy"
                                                            value="1"
                                                            wire:change="updateData('rent_to_buy', $event.target.checked)">
                                                        Rent-to-Buy
                                                    </label>
                                                    <p>R2B Option</p>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 mt-3 mt-2">
                                                        <div class="form-group">
                                                            <label class="form-label" for="minimum_term">Minimum
                                                                Term</label>
                                                            <select wire:model="short_term_minimum_term"
                                                                class="form-control">
                                                    ...
                                                    <div class="col-md-4 mt-3 mt-2">
                                                        <div class="form-group">
                                                            <label class="form-label" for="maximum_term">Maximum
                                                                Term</label>
                                                            <select wire:model="short_term_maximum_term"
                                                    ...
                                                    <div class="col-md-4 mt-3 mt-2">
                                                        <div class="form-group">
                                                            <label class="form-label" for="pricing_cadence">Pricing
                                                                Cadence</label>
                                                            <select wire:model="short_term_pricing_cadence"
                                                                class="form-control" readonly>
                                                    ...
                                                    <div class="col-md-6 mt-3 mt-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input wire:model="short_term_weekly_price_wo_ins"
                                                                type="text" min="1" class="form-control"
                                                                pattern="^[0-9]+(\.[0-9]{2}){0,1}$" step="0.01"
                                                                maxlength="20">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mt-3 mt-2">
                                                        <div class="form-group">
                                                            <label class="form-label" for="weekly_price_w_ins">Weekly
                                                                ...
                                                                {{ settings('currency_symbol', '$') }}</label>
                                                            <input wire:model="short_term_weekly_price_w_ins"
                                                                type="text" min="1" class="form-control"
                                                                pattern="^[0-9]+(\.[0-9]{2}){0,1}$" step="0.01"
                                                                maxlength="20">
                                                        </div>
                                                    ...
                                                    <div class="col-md-12 mt-2">
                                                        <div class="form-group">
                                                            <label class="form-label" for="maintenance_included">
                                                                <input wire:model="short_term_maintenance_included"
                                                                    type="checkbox">
                                                    ...
                                                    <div class="col-md-4 mt-2">
                                                        <div class="form-group">
                                                            <label class="form-label" for="deposit">Deposit
                                                                {{ settings('currency_symbol', '$') }}</label>
                                                            <input wire:model="short_term_deposit" type="text"
                                                    ...
                                                    <div class="col-md-4 mt-2">
                                                        <div class="form-group">
                                                            <label class="form-label"
                                                                for="excess_liability">Excess/Liability
                                                                {{ settings('currency_symbol', '$') }}</label>
                                                            <input wire:model="short_term_excess_liability"
                                                                type="text" min="1" class="form-control"
                                                                pattern="^[0-9]+(\.[0-9]{2}){0,1}$" step="0.01"
                                                                maxlength="20">
                                                        </div>
                                                    ...
                                                    <div class="col-md-4 mt-2">
                                                        <div class="form-group">
                                                            <label class="form-label" for="early_return_fee">Early
                                                                Return Fee
                                                                {{ settings('currency_symbol', '$') }}</label>
                                                            <input wire:model="short_term_early_return_fee"
                                                                type="text" min="1" class="form-control"
                                                                pattern="^[0-9]+(\.[0-9]{2}){0,1}$" step="0.01"
                                                                maxlength="20">
                                                        </div>
                                                    ...
                                                    <div class="col-md-12 mt-2">
                                                        <div class="form-group">
                                                            <label class="form-label"
                                                                for="notice_period_to_return">Notice Period to
                                                                Return</label>
                                                            <input wire:model="short_term_notice_period_to_return"
                                                                type="text" min="1" class="form-control"
                                                                pattern="^[0-9]+(\.[0-9]{2}){0,1}$" step="0.01"
                                                                maxlength="20">
                                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 mt-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="billing_cycle">Billing
                                                                Cycle</label>
                                                            <select wire:model="long_term_billing_cycle"
                                                                class="form-control">
                                                                <option value="">Select</option>
                                                                <option value="weekly">Weekly</option>
                                                    ...
                                                    <div class="col-md-6 mt-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input wire:model="long_term_default_deposit"
                                                                type="text" min="1" class="form-control"
                                                                pattern="^[0-9]+(\.[0-9]{2}){0,1}$" step="0.01"
                                                                maxlength="20">
                                                        </div>
                                                    ...
                                                    <div class="col-md-2 mt-2">
                                                        <div class="form-group">
                                                            <label class="form-label" for="long_term_term_options">
                                                                <input wire:model="long_term_term_options"
                                                                    type="checkbox" value="3m"
                                                                    wire:change="updateLttOptions($event.target.value, $event.target.checked  )">
                                                                3 Months
                                                            </label>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <tbody>
                                                            @if (in_array('3m', $long_term_term_options))
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text" min="1"
                                                                            wire:model="long_term_prices.3m.price_wo_ins"
                                                                            class="form-control"
                                                                            pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                                            step="0.01" maxlength="20">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" min="1"
                                                                            wire:model="long_term_prices.3m.price_w_ins"
                                                                            class="form-control"
                                                                            pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                                            step="0.01" maxlength="20">
                                                                    </td>
                                                                    <td>
                                                                        <input type="checkbox"
                                                                            wire:model="long_term_prices.3m.maintenance_included"
                                                                            wire:change="updateMaintenanceField('3m', $event.target.checked)">
                                                                    </td>
                                                                    <td>
                                                                        @if (
                                                                            !isset($long_term_prices['3m']) ||
                                                                                !isset($long_term_prices['3m']['maintenance_included']) ||
                                                                                !$long_term_prices['3m']['maintenance_included']
                                                                        )
                                                                            <select class="form-control"
                                                                                wire:model="long_term_prices.3m.maintenance_type">
                                                                                <option value="">Select</option>
                                                                    ...
                                                                    <td>
                                                                        @if (
                                                                            ...
                                                                            <input type="text" min="1"
                                                                                wire:model="long_term_prices.3m.maintenance_price"
                                                                                class="form-control"
                                                                                pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                                                step="0.01" maxlength="20">
                                                                        @endif
                                                                    ...
                                                                    <td>
                                                                        <input type="text" min="1"
                                                                            wire:model="long_term_prices.3m.mileage"
                                                                            class="form-control"
                                                                            pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                                            step="0.01" maxlength="20">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" min="1"
                                                                            wire:model="long_term_prices.3m.excess_rate"
                                                                            class="form-control"
                                                                            pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                                            step="0.01" maxlength="20">
                                                                    </td>
                                                            ...
                                                            @if (in_array('6m', $long_term_term_options))
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text" min="1"
                                                                            wire:model="long_term_prices.6m.price_wo_ins"
                                                                            class="form-control"
                                                                            pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                                            step="0.01" maxlength="20">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" min="1"
                                                                            wire:model="long_term_prices.6m.price_w_ins"
                                                                            class="form-control"
                                                                            pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                                            step="0.01" maxlength="20">
                                                                    </td>
                                                                    <td>
                                                                        <input type="checkbox"
                                                                            wire:model="long_term_prices.6m.maintenance_included"
                                                                            wire:change="updateMaintenanceField('6m', $event.target.checked)">
                                                                    </td>
                                                                    <td>
                                                                        @if (
                                                                            !isset($long_term_prices['6m']) ||
                                                                                !isset($long_term_prices['6m']['maintenance_included']) ||
                                                                                !$long_term_prices['6m']['maintenance_included']
                                                                        )
                                                                            <select class="form-control"
                                                                                wire:model="long_term_prices.6m.maintenance_type">
                                                                                <option value="">Select</option>
                                                                                <option value="basic">Basic</option>
                                                                                <option value="full">Full</option>
                                                                            </select>
                                                                    ...
                                                                    <td>
                                                                        @if (
                                                                            ...
                                                                            <input type="text" min="1"
                                                                                wire:model="long_term_prices.6m.maintenance_price"
                                                                                class="form-control"
                                                                                pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                                                step="0.01" maxlength="20">
                                                                        @endif
                                                                    ...
                                                                    <td>
                                                                        <input type="text" min="1"
                                                                            wire:model="long_term_prices.6m.mileage"
                                                                            class="form-control"
                                                                            pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                                            step="0.01" maxlength="20">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" min="1"
                                                                            wire:model="long_term_prices.6m.excess_rate"
                                                                            class="form-control"
                                                                            pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                                            step="0.01" maxlength="20">
                                                                    </td>
                                                            ...
                                                            @if (in_array('9m', $long_term_term_options))
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text" min="1"
                                                                            wire:model="long_term_prices.9m.price_wo_ins"
                                                                            class="form-control"
                                                                            pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                                            step="0.01" maxlength="20">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" min="1"
                                                                            wire:model="long_term_prices.9m.price_w_ins"
                                                                            class="form-control">
                                                                    </td>
                                                                    <td>
                                                                        <input type="checkbox"
                                                                            wire:model="long_term_prices.9m.maintenance_included"
                                                                            wire:change="updateMaintenanceField('9m', $event.target.checked)"
                                                                            pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                                            step="0.01" maxlength="20">
                                                                    </td>
                                                                    <td>
                                                                        @if (
                                                                            !isset($long_term_prices['9m']) ||
                                                                                !isset($long_term_prices['9m']['maintenance_included']) ||
                                                                                !$long_term_prices['9m']['maintenance_included']
                                                                        )
                                                                            <select class="form-control"
                                                                                wire:model="long_term_prices.9m.maintenance_type">
                                                                                <option value="">Select</option>
                                                                                <option value="basic">Basic</option>
                                                                                <option value="full">Full</option>
                                                                            </select>
                                                                    ...
                                                                    <td>
                                                                        @if (
                                                                            ...
                                                                            <input type="text" min="1"
                                                                                wire:model="long_term_prices.9m.maintenance_price"
                                                                                class="form-control"
                                                                                pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                                                step="0.01" maxlength="20">
                                                                        @endif
                                                                    ...
                                                                    <td>
                                                                        <input type="text" min="1"
                                                                            wire:model="long_term_prices.9m.mileage"
                                                                            class="form-control"
                                                                            pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                                            step="0.01" maxlength="20">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" min="1"
                                                                            wire:model="long_term_prices.9m.excess_rate"
                                                                            class="form-control"
                                                                            pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                                            step="0.01" maxlength="20">
                                                                    </td>
                                                            ...
                                                            @if (in_array('12m', $long_term_term_options))
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text" min="1"
                                                                            wire:model="long_term_prices.12m.price_wo_ins"
                                                                            class="form-control"
                                                                            pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                                            step="0.01" maxlength="20">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" min="1"
                                                                            wire:model="long_term_prices.12m.price_w_ins"
                                                                            class="form-control"
                                                                            pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                                            step="0.01" maxlength="20">
                                                                    </td>
                                                                    <td>
                                                                        <input type="checkbox"
                                                                            wire:model="long_term_prices.12m.maintenance_included"
                                                                            wire:change="updateMaintenanceField('12m', $event.target.checked)">
                                                                    </td>
                                                                    <td>
                                                                        @if (
                                                                            !isset($long_term_prices['12m']) ||
                                                                                !isset($long_term_prices['12m']['maintenance_included']) ||
                                                                                !$long_term_prices['12m']['maintenance_included']
                                                                        )
                                                                            <select class="form-control"
                                                                                wire:model="long_term_prices.12m.maintenance_type">
                                                                                <option value="">Select</option>
                                                                                <option value="basic">Basic</option>
                                                                                <option value="full">Full</option>
                                                                            </select>
                                                                    ...
                                                                    <td>
                                                                        @if (
                                                                            ...
                                                                            <input type="text" min="1"
                                                                                wire:model="long_term_prices.12m.maintenance_price"
                                                                                class="form-control"
                                                                                pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                                                step="0.01" maxlength="20">
                                                                        @endif
                                                                    ...
                                                                    <td>
                                                                        <input type="text" min="1"
                                                                            wire:model="long_term_prices.12m.mileage"
                                                                            class="form-control"
                                                                            pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                                            step="0.01" maxlength="20">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" min="1"
                                                                            wire:model="long_term_prices.12m.excess_rate"
                                                                            class="form-control"
                                                                            pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                                            step="0.01" maxlength="20">
                                                                    </td>
                                                            ...
                                                            @if (in_array('18m', $long_term_term_options))
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text" min="1"
                                                                            wire:model="long_term_prices.18m.price_wo_ins"
                                                                            class="form-control"
                                                                            pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                                            step="0.01" maxlength="20">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" min="1"
                                                                            wire:model="long_term_prices.18m.price_w_ins"
                                                                            class="form-control"
                                                                            pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                                            step="0.01" maxlength="20">
                                                                    </td>
                                                                    <td>
                                                                        <input type="checkbox"
                                                                            wire:model="long_term_prices.18m.maintenance_included"
                                                                            wire:change="updateMaintenanceField('18m', $event.target.checked)">
                                                                    </td>
                                                                    <td>
                                                                        @if (
                                                                            !isset($long_term_prices['18m']) ||
                                                                                !isset($long_term_prices['18m']['maintenance_included']) ||
                                                                                !$long_term_prices['18m']['maintenance_included']
                                                                        )
                                                                            <select class="form-control"
                                                                                wire:model="long_term_prices.18m.maintenance_type">
                                                                                <option value="">Select</option>
                                                                                <option value="basic">Basic</option>
                                                                                <option value="full">Full</option>
                                                                            </select>
                                                                    ...
                                                                    <td>
                                                                        @if (
                                                                            ...
                                                                            <input type="text" min="1"
                                                                                wire:model="long_term_prices.18m.maintenance_price"
                                                                                class="form-control"
                                                                                pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                                                step="0.01" maxlength="20">
                                                                        @endif
                                                                    ...
                                                                    <td>
                                                                        <input type="text" min="1"
                                                                            wire:model="long_term_prices.18m.mileage"
                                                                            class="form-control"
                                                                            pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                                            step="0.01" maxlength="20">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" min="1"
                                                                            wire:model="long_term_prices.18m.excess_rate"
                                                                            class="form-control"
                                                                            pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                                            step="0.01" maxlength="20">
                                                                    </td>
                                                    ...
                                                    <div class="col-md-6 mt-2">
                                                        <div class="form-group">
                                                            <label class="form-label">Excess/Liability
                                                                {{ settings('currency_symbol', '$') }}</label>
                                                            <input wire:model="long_term_excess_liability"
                                                                type="text" min="1" class="form-control"
                                                                pattern="^[0-9]+(\.[0-9]{2}){0,1}$" step="0.01"
                                                                maxlength="20">
                                                        </div>
                                                    ...
                                                    <div class="col-md-6 mt-2">
                                                        <div class="form-group">
                                                            <label>
                                                                <input wire:model="long_term_vehicle_swap_allowed"
                                                                    type="checkbox">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4 mt-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input wire:model="rent_to_buy_term" type="text"
                                                                min="1" class="form-control"
                                                                pattern="^[0-9]+(\.[0-9]{2}){0,1}$" step="0.01"
                                                                maxlength="20">
                                                        </div>
                                                    ...
                                                    <div class="col-md-4 mt-2">
                                                        <div class="form-group">
                                                            ...
                                                            <select wire:model="rent_to_buy_billing_cycle"
                                                                class="form-control">
                                                                <option value="">Select</option>
                                                                <option value="weekly">Weekly</option>
                                                                <option value="monthly">Monthly</option>
                                                    ...
                                                    <div class="col-md-4 mt-2">
                                                        <div class="form-group">
                                                            <label class="form-label">Price Per Cycle
                                                                {{ settings('currency_symbol', '$') }}</label>
                                                            <input wire:model="rent_to_buy_price_per_cycle"
                                                                type="text" min="1" class="form-control"
                                                                pattern="^[0-9]+(\.[0-9]{2}){0,1}$" step="0.01"
                                                                maxlength="20">
                                                        </div>
                                                    ...
                                                    <div class="col-md-4 mt-2">
                                                        <div class="form-group">
                                                            <label class="form-label">Deposit Amount
                                                                {{ settings('currency_symbol', '$') }}</label>
                                                            <input wire:model="rent_to_buy_deposit_amount"
                                                                type="text" min="1" class="form-control"
                                                                pattern="^[0-9]+(\.[0-9]{2}){0,1}$" step="0.01"
                                                                maxlength="20">
                                                        </div>
                                                    ...
                                                    <div class="col-md-4 mt-2">
                                                        <div class="form-group">
                                                            <label class="form-label">Balloon Payment
                                                                {{ settings('currency_symbol', '$') }}</label>
                                                            <input wire:model="rent_to_buy_balloon_payment"
                                                                type="text" min="1" class="form-control"
                                                                pattern="^[0-9]+(\.[0-9]{2}){0,1}$" step="0.01"
                                                                maxlength="20">
                                                        </div>
                                                    ...
                                                    <div class="col-md-4 mt-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input wire:model="rent_to_buy_payment_break_weeks_year"
                                                                type="text" min="1" class="form-control"
                                                                pattern="^[0-9]+(\.[0-9]{2}){0,1}$" step="0.01"
                                                                maxlength="20">
                                                        </div>
                                                    ...
                                                    <div class="col-md-6 mt-2">
                                                        <div class="form-group">
                                                            <label class="form-label">Mileage Allowance (Per
                                                                Cycle)</label>
                                                            <input wire:model="rent_to_buy_mileage_allowance_per_cycle"
                                                                type="text" min="1" class="form-control"
                                                                pattern="^[0-9]+(\.[0-9]{2}){0,1}$" step="0.01"
                                                                maxlength="20">
                                                        </div>
                                                    ...
                                                    <div class="col-md-6 mt-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input wire:model="rent_to_buy_excess_mileage_rate"
                                                                type="text" min="1" class="form-control"
                                                                pattern="^[0-9]+(\.[0-9]{2}){0,1}$" step="0.01"
                                                                maxlength="20">
                                                        </div>
                                                    ...
                                                    <div class="col-md-4 mt-2">
                                                        <div class="form-group">
                                                            <label class="form-label">
                                                                <input wire:model="rent_to_buy_insurance_included"
                                                                    type="checkbox">
                                                                Insurance Included
                                                            </label>
                                                        </div>
                                                    ...
                                                    <div class="col-md-4 mt-2">
                                                        <div class="form-group">
                                                            <label class="form-label">
                                                                <input wire:model="rent_to_buy_maintenance_included"
                                                                    type="checkbox">
                                                                Maintenance Included
                                                            </label>
                                                        </div>
                                                    ...
                                                    <div class="col-md-4 mt-2">
                                                        <div class="form-group">
                                                            <label class="form-label">
                                                                <input wire:model="rent_to_buy_ev_incentive_included"
                                                                    type="checkbox">
                            ...
                            @if ($step == 2)
                                <div style="margin-top: 10px; text-align: left; font-size: 20px;  font-weight: bold;">
                                    Enter pricing rates inclusive of all applicable taxes. </div>
                                <div wire:key="2" class="row">
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <div for="daily_rate" class="d-flex justify-content-between">
                                                ...
                                                <div>
                                                    <div class="form-control-wrap">
                                                        <div class="form-check form-switch">
                                                            <input type="checkbox" class="form-check-input"
                                                                id="daily_rate_tax_incl"
                                                                wire:model.live="daily_rate_tax_incl"
                                                                style="width: 3em; height: 1.5em; margin-top : -1px"
                                                                disabled>
                                                            <label class="form-check-label ms-2"
                                                                for="daily_rate_tax_incl">
                                            ...
                                            <input type="text" min="1" wire:model.live="daily_rate"
                                                name="daily_rate" class="form-control form-control-lg" data-ui="xl"
                                                id="daily_rate" pattern="^[0-9]+(\.[0-9]{2}){0,1}$" step="0.01"
                                                maxlength="20">
                                        </div>
                                    </div>
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            <div for="weekly_rate" class="d-flex justify-content-between">
                                                ...
                                                <div>
                                                    <div class="form-control-wrap">
                                                        <div class="form-check form-switch">
                                                            <input type="checkbox" class="form-check-input"
                                                                id="weekly_rate_tax_incl"
                                                                wire:model.live="weekly_rate_tax_incl"
                                                                style="width: 3em; height: 1.5em; margin-top : -1px"
                                                                disabled>
                                                            <label class="form-check-label ms-2"
                                                                for="weekly_rate_tax_incl">
                                            ...
                                            <input type="text" min="1" wire:model.live="weekly_rate"
                                                name="weekly_rate" class="form-control form-control-lg"
                                                data-ui="xl" id="weekly_rate" pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                step="0.01" maxlength="20">
                                        </div>
                                    </div>
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            <div for="monthly_rate" class="d-flex justify-content-between">
                                                ...
                                                <div>
                                                    <div class="form-control-wrap">
                                                        <div class="form-check form-switch">
                                                            <input type="checkbox" class="form-check-input"
                                                                id="monthly_rate_tax_incl"
                                                                wire:model.live="monthly_rate_tax_incl"
                                                                style="width: 3em; height: 1.5em; margin-top : -1px"
                                                                disabled>
                                                            <label class="form-check-label ms-2"
                                                                for="monthly_rate_tax_incl">
                                            ...
                                            <input type="text" min="1" wire:model.live="monthly_rate"
                                                name="monthly_rate" class="form-control form-control-lg"
                                                data-ui="xl" id="monthly_rate" pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                step="0.01" maxlength="20">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-3">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="button" wire:confirm="Are you sure?"
                                                                wire:click="removeDynamicPricing({{ $loop->index }})"
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div style="background: #fbfbfb;border-radius: 15px;padding: 20px;">
                                            <div class="form-group">
                                                ...
                                                <input type="text" wire:model.live="dynamic_pricing_rule_name"
                                                    minlength="3" maxlength="100" name="rule_name"
                                                    class="form-control form-control-lg" data-ui="xl"
                                                    id="rule_name">
                                                @error('dynamic_pricing_rule_name')
                                                    <span class="error">Rule name is required</span>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                <label for="adjustment_type">Adjustment Type</label>
                                                <select wire:model.live="dynamic_pricing_adjustment_type"
                                                    name="adjustment_type" class="form-control form-control-lg"
                                                    data-ui="xl" id="adjustment_type">
                                                    <option value="percentage_increase">Percentage Increase</option>
                                                    <option value="fixed_surcharge">Fixed Surcharge</option>
                                                    <option value="fixed_price">Fixed Price</option>
                                                </select>
                                                @error('dynamic_pricing_adjustment_type')
                                                    <span class="error">Adjustment type is required</span>
                                                @enderror
                                            </div>
                                            @if ($dynamic_pricing_adjustment_type == 'percentage_increase')
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" min="1" max="100"
                                                        wire:model.live="dynamic_pricing_adjustment_value"
                                                        name="adjustment_value" class="form-control form-control-lg"
                                                        data-ui="xl" id="adjustment_value"
                                                        pattern="^[0-9]+(\.[0-9]{2}){0,1}$" step="0.01"
                                                        maxlength="20">
                                                    @error('dynamic_pricing_adjustment_value')
                                                        <span class="error">Adjustment value is required</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group" wire:ignore>
                                                ...
                                                <input type="text" data-type="date" maxlength="20"
                                                    wire:model="dynamic_pricing_start_date" name="start_date"
                                                    class="form-control form-control-lg flatpickr" data-ui="xl"
                                                    id="start_date" placeholder="YYYY-MM-DD">
                                                @error('dynamic_pricing_start_date')
                                            ...
                                            <div class="form-group" wire:ignore>
                                                ...
                                                <input type="text" data-type="date" maxlength="20"
                                                    wire:model="dynamic_pricing_end_date" name="end_date"
                                                    class="form-control form-control-lg flatpickr" data-ui="xl"
                                                    id="end_date" placeholder="YYYY-MM-DD">
                                                @error('dynamic_pricing_end_date')
                                                    <span class="error">End date is required</span>
                                                @enderror
                                            </div>
                                            <div class="text-center">
                                                <button type="button" wire:click="addDynamicPricing"
                                    ...
                                    <div class="col-md-6 mt-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap custom-select-wrapper">
                                                <select wire:model="fuel_type" class="form-control form-control-lg"
                                                    id="fuel_type"
                                                    wire:change="updateData('fuel_type', $event.target.value)">
                                                ...
                                                <span class="select-icon"> <i class="fas fa-chevron-down"></i>
                                                </span>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap" wire:ignore>
                                                <input wire:model="mots.test_date" type="text" data-type="date"
                                                    class="form-control flatpickr @error('mots.test_date') error @enderror  form-control-xl"
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap" wire:ignore>
                                                <input wire:model="mots.expiry_date" type="text"
                                                    data-type="date"
                                                    class="form-control flatpickr @error('mots.expiry_date') error @enderror  form-control-xl"
                                                    id="expiry_date" placeholder="YYYY-MM-DD" />
                                                @error('mots.expiry_date')
                                                    <span class="invalid">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                    ...
                                    @if ($is_taxed == 1)
                                        <div class="col-md-6 mt-3">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap" wire:ignore>
                                                    <input wire:model="tax_expiry_date" type="text"
                                                        data-type="date"
                                                        class="form-control flatpickr @error('tax_expiry_date') error @enderror  form-control-xl"
                                                        id="tax_expiry_date" maxlength="20"
                                                        placeholder="YYYY-MM-DD" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input wire:model="tax_amount" type="text" step="any"
                                                        ...
                                                        id="tax_amount" pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                        step="0.01" maxlength="20" />
                                                    @error('tax_amount')
                                                        <span class="invalid">{{ $message }}</span>
                                                    @enderror
                            ...
                            @if ($step == 6)
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-6 mt-3">
                                        <div class="form-group">
                                            <label class="form-label" for="last_service_date">Last Service
                                                Date</label>
                                            <div class="form-control-wrap" wire:ignore>
                                                <input wire:model="service.last_service_date" type="text"
                                                    data-type="date"
                                                    class="form-control flatpickr @error('service.last_service_date') error @enderror  form-control-xl"
                                                    id="last_service_date" maxlength="20"
                                                    placeholder="YYYY-MM-DD" />
                                                @error('service.last_service_date')
                                                    <span class="invalid">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 mt-3">
                                        <div class="form-group">
                                            <label class="form-label" for="next_service_date">Next Service
                                                Date</label>
                                            <div class="form-control-wrap" wire:ignore>
                                                <input wire:model="service.next_service_date" type="text"
                                                    data-type="date"
                                                    class="form-control flatpickr @error('service.next_service_date') error @enderror  form-control-xl"
                                                    id="next_service_date" maxlength="20"
                                                    placeholder="YYYY-MM-DD" />
                                                @error('service.next_service_date')
                                                    <span class="invalid">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input wire:model="service.last_service_mileage" type="text"
                                                    ...
                                                    id="last_service_mileage" pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                    step="0.01" maxlength="20" />
                                                @error('service.last_service_mileage')
                                                    <span class="invalid">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input wire:model="service.next_service_mileage" type="text"
                                                    ...
                                                    id="next_service_mileage" pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                    step="0.01" maxlength="20" />
                                                @error('service.next_service_mileage')
                                                    <span class="invalid">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                            ...
                            @if ($step == 7)
                                <div class="mt-4">
                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                <label for="customerReviews" class="form-label">Customer
                                                    Reviews</label>
                                                <textarea class="form-control" id="customerReviews" rows="4" wire:model="driver.customer_reviews"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="email" class="form-control" id="emailAddress"
                                                wire:model="driver.email_address"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="workingHours" rows="3" wire:model="driver.working_hours"
                                            placeholder="Standard Hours, Overtime..."></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="driverBreaks" class="form-label">Driver Breaks</label>
                                        <textarea class="form-control" id="driverBreaks" rows="3" wire:model="driver.driver_breaks"
                                            placeholder="Mandatory Breaks, Extended Trips..."></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="accommodation" class="form-label">Accommodation for Overnight
                                            Stays</label>
                                        <textarea class="form-control" id="accommodation" rows="3" wire:model="driver.accommodation"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="tollTax" rows="3" wire:model="driver.toll_tax"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="dropoffLocation" rows="3" wire:model="driver.dropoff_location"
                                            placeholder="Different Drop-off Location..."></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="miscellaneous" class="form-label">Miscellaneous</label>
                                        <textarea class="form-control" id="miscellaneous" rows="3" wire:model="driver.miscellaneous"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="button"
                                                                ...
                                                                class="btn btn-warning" wire:confirm="Are you sure?"
                                                                wire:click="removeExtra({{ $index }})">Remove</button>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        ...
                                        <div style="background: #fbfbfb;border-radius: 15px;padding: 20px;">
                                            <div class="form-group">
                                                <input class="form-control  form-control-lg" type="text"
                                                    wire:model="extras.title" placeholder="Title" maxlength="50">
                                                @error('extras.title')
                                                    <span class="error">This title is required</span>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                <input class="form-control  form-control-lg" type="text"
                                                    wire:model="extras.description" placeholder="Description"
                                                    maxlength="200">
                                                @error('extras.description')
                                                    <span class="error">This description is required</span>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                <input class="form-control form-control-lg" min="1"
                                                    type="text" wire:model="extras.price"
                                                    placeholder="Price {{ settings('currency_symbol', '$') }}"
                                                    pattern="^[0-9]+(\.[0-9]{2}){0,1}$" step="0.01"
                                                    maxlength="20">
                                                @error('extras.price')
                                                    <span class="error">This price is required</span>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                <select class="form-control form-control-lg select2"
                                                    wire:model="extras.interval" placeholder="Interval">
                                                    <option value="">Select Interval</option>
                                                    <option value="daily">Daily</option>
                                                    <option value="weekly">Weekly</option>
                                                    <option value="one_time">One Time</option>
                                                </select>
                                                @error('extras.interval')
                                                    <span class="error">This interval is required</span>
                                                @enderror
                                            </div>
                                            <div class="form-group mt-3">
                                                <button type="button" wire:click.prevent="addExtras"
                            ...
                            @if ($step == 9)
                                <div class="row mt-3">
                                    <div class="col-12 mb-2">
                                        <div class="form-group">
                                            <label class="form-label" for="requirements">Booking requirements
                                            </label>
                                            <div class="form-control-wrap" x-data="{
                                                ...
                                                x-init="initSummernote()" wire:ignore>
                                                <textarea class="form-control form-control-lg" id="requirements" wire:model="requirements"
                                                    placeholder="Enter requirements" x-ref="editor">{{ $requirements }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 mb-2">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap" x-data="{
                                                ...
                                                x-init="initSummernote()" wire:ignore>
                                                <textarea class="form-control form-control-lg" id="security_deposit" wire:model="security_deposit"
                                                    placeholder="Enter security_deposit" x-ref="editor">{{ $security_deposit }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 mb-2">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap" x-data="{
                                                ...
                                                <textarea class="form-control form-control-lg" id="damage_excess" wire:model="damage_excess"
                                                    placeholder="Enter damage excess" x-ref="editor">{{ $damage_excess }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 mb-2">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap" x-data="{
                                                ...
                                                <textarea class="form-control form-control-lg" id="mileage_text" wire:model="mileage_text"
                                                    placeholder="Enter mileage text" x-ref="editor">{{ $mileage_text }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 mb-2">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap" x-data="{
                                                ...
                                                <textarea class="form-control form-control-lg" id="important_text" wire:model="important_text"
                                                    placeholder="Enter important text for booking" x-ref="editor">{{ $important_text }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap" wire:ignore>
                                                <input wire:model="document.upload_date" type="text"
                                                    data-type="date"
                                                    class="form-control flatpickr @error('document.upload_date') error @enderror  form-control-xl"
                                                    id="document.upload_date" placeholder="YYYY-MM-DD" />
                                                @error('document.upload_date')
                                                    <span class="invalid">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap" wire:ignore>
                                                <input wire:model="document.expiry_date" type="text"
                                                    data-type="date"
                                                    class="form-control flatpickr @error('document.expiry_date') error @enderror  form-control-xl"
                                                    id="document.expiry_date" placeholder="YYYY-MM-DD" />
                                                @error('document.expiry_date')
                                                    <span class="invalid">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap" wire:ignore>
                                                <input wire:model="document.action_date" type="text"
                                                    data-type="date"
                                                    class="form-control flatpickr @error('document.action_date') error @enderror  form-control-xl"
                                                    id="document.action_date" placeholder="YYYY-MM-DD" />
                                                @error('document.action_date')
                                                    <span class="invalid">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            <label class="form-label"
                                                for="document.file">{{ __('admin.file') }}</label>
                                            <div class="form-control-wrap">
                            ...
                            @if ($step == 11)
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            <label class="form-label"
                                                for="finance.purchase_price">{{ __('admin.purchase_price') }}
                                                {{ settings('currency_symbol', '$') }}</label>
                                            <div class="form-control-wrap">
                                                <input wire:model="finance.purchase_price" type="text"
                                                    step="any"
                                                    class="form-control @error('finance.purchase_price') error @enderror  form-control-xl"
                                                    id="finance.finance_type" pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                    step="0.01" maxlength="20" />
                                                @error('finance.purchase_price')
                                                    <span class="invalid">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                @error('finance.agreement_number')
                                                    <span class="invalid">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap" wire:ignore>
                                                <input wire:model="finance.agreement_start_date" type="text"
                                                    data-type="date"
                                                    class="form-control flatpickr @error('finance.agreement_start_date') error @enderror  form-control-xl"
                                                    id="finance.agreement_start_date" placeholder="YYYY-MM-DD" />
                                                @error('finance.agreement_start_date')
                                                    <span class="invalid">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap" wire:ignore>
                                                <input wire:model="finance.agreement_end_date" type="text"
                                                    data-type="date"
                                                    class="form-control flatpickr @error('finance.agreement_end_date') error @enderror  form-control-xl"
                                                    id="finance.agreement_end_date" placeholder="YYYY-MM-DD" />
                                                @error('finance.agreement_end_date')
                                                    <span class="invalid">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            <label class="form-label"
                                                for="finance.loan_amount">{{ __('admin.loan_amount') }}
                                                {{ settings('currency_symbol', '$') }}</label>
                                            <div class="form-control-wrap">
                                                <input wire:model="finance.loan_amount" type="text"
                                                    step="any"
                                                    class="form-control @error('finance.loan_amount') error @enderror  form-control-xl"
                                                    id="finance.loan_amount" pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                    step="0.01" maxlength="20" />
                                                @error('finance.loan_amount')
                                                    <span class="invalid">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                ...
                                <div wire:key="3" class="row mt-3">
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap" wire:ignore>
                                                <input wire:model="damage.reported_date" type="text"
                                                    data-type="date"
                                                    class="form-control flatpickr @error('damage.reported_date') error @enderror  form-control-xl"
                                                    id="damage.reported_date" placeholder="YYYY-MM-DD" />
                                                @error('damage.reported_date')
                                                    <span class="invalid">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap" wire:ignore>
                                                <input wire:model="damage.incident_date" type="text"
                                                    data-type="date"
                                                    class="form-control flatpickr @error('damage.incident_date') error @enderror  form-control-xl"
                                                    id="damage.incident_date" placeholder="YYYY-MM-DD" />
                                                @error('damage.incident_date')
                                                    <span class="invalid">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                @error('damage.insurance_reference_no')
                                                    <span class="invalid">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            <label class="form-label"
                                                for="damage.total_claim_cost">{{ __('admin.total_claim_cost') }}
                                                {{ settings('currency_symbol', '$') }}</label>
                                            <div class="form-control-wrap">
                                                <input wire:model="damage.total_claim_cost" type="text"
                                                    step="any"
                                                    class="form-control @error('damage.total_claim_cost') error @enderror  form-control-xl"
                                                    id="damage.total_claim_cost" pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                    step="0.01" maxlength="20" />
                                                @error('damage.total_claim_cost')
                                                    <span class="invalid">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap" wire:ignore>
                                                <input wire:model="repair.booking_date" type="text"
                                                    data-type="date"
                                                    class="form-control flatpickr @error('repair.booking_date') error @enderror  form-control-xl"
                                                    id="repair.booking_date" placeholder="YYYY-MM-DD" />
                                                @error('repair.booking_date')
                                                    <span class="invalid">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap" wire:ignore>
                                                <input wire:model="repair.date_time" type="text"
                                                    data-type="datetime"
                                                    class="form-control flatpickr @error('repair.date_time') error @enderror  form-control-xl"
                                                    id="damage.insurance_reference_no"
                                                    placeholder="YYYY-MM-DD hh:mm AA" />
                                                @error('repair.date_time')
                                                    <span class="invalid">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            <label class="form-label"
                                                for="repair.total_cost">{{ __('admin.total_cost') }}
                                                {{ settings('currency_symbol', '$') }}</label>
                                            <div class="form-control-wrap">
                                                <input wire:model="repair.total_cost" type="text"
                                                    step="any"
                                                    class="form-control @error('repair.total_cost') error @enderror  form-control-xl"
                                                    id="repair.total_cost" pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                    step="0.01" maxlength="20" />
                                                @error('repair.total_cost')
                                                    <span class="invalid">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input wire:model="repair.invoice" type="file"
                                                    ...
                                                    id="repair.invoice" pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                    step="0.01" maxlength="20" />
                                                @error('repair.invoice')
                                                    <span class="invalid">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                        ...
                                        <tbody>
                                            @foreach ($pcns as $item)
                                                <tr>
                                                    ...
                                                    <td><a href="{{ route('admin.driverPcn', $item->driver->id ?? '') }}"
                                                            class="btn btn-sm btn-primary">{{ $item->driver->first_name ?? '' }}
                                                            {{ $item->driver->last_name ?? '' }}</a></td>
                                                ...
                                                <tbody>
                                                    @foreach ($car->bookings as $item)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a
                                                                    href="{{ route('admin.bookings.show', $item->id) }}">{{ $item->booking_number }}</a>
                                                            </td>
                                                            <td>{{ $item->created_at->format('Y-m-d H:i:s') }}</td>
                                                            <td>{{ $item->pick_up_date }} {{ $item->pick_up_time }}
                                                            </td>
                                                            <td>{{ $item->days }} {{ __('admin.booking_days') }}
                                                            </td>
                                                            ...
                                                            <td>
                                                                @if ($item?->customer)
                                                                    <a
                                                                        href="{{ route('admin.user.show', $item?->customer?->id) }}">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-6 mt-3">
                                        <div class="form-group">
                                            ...
                                            @error('subscription.tfl_congestion_charge')
                                                <span class="invalid">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-md-6 mt-3">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                ...
                                                <input id="dartford_charge"
                                                    wire:model="subscription.dartford_charge" value="yes"
                                                    type="radio" /> <span class="me-3">Yes</span>
                                                <input id="dartford_charge"
                                                    wire:model="subscription.dartford_charge" value="no"
                                                    type="radio" /> No

                                            </div>
                                            @error('subscription.dartford_charge')
                                                <span class="invalid">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-md-6 mt-3">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                ...
                                                <input id="heathrow_airport"
                                                    wire:model="subscription.heathrow_airport" value="yes"
                                                    type="radio" /> <span class="me-3">Yes</span>
                                                <input id="heathrow_airport"
                                                    wire:model="subscription.heathrow_airport" value="no"
                                                    type="radio" /> No

                                            </div>
                                            @error('subscription.heathrow_airport')
                                                <span class="invalid">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-md-6 mt-3">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                ...
                                                <input id="gatwick_airport"
                                                    wire:model="subscription.gatwick_airport" value="yes"
                                                    type="radio" /> <span class="me-3">Yes</span>
                                                <input id="gatwick_airport"
                                                    wire:model="subscription.gatwick_airport" value="no"
                                                    type="radio" /> No

                                            </div>
                                            @error('subscription.gatwick_airport')
                                                <span class="invalid">{{ $message }}</span>
                                            @enderror
                                ...
                                <div class="row">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="button"
                                                                wire:key="remove-{{ $index }}"
                                                                class="btn btn-warning" wire:confirm="Are you sure?"
                                                                wire:click="removeInsuranceCoverage({{ $index }})">Remove</button>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                    ...
                                    <div class="col-4 mt-2">
                                        <div style="background: #fbfbfb;border-radius: 15px;padding: 20px;">
                                            <div class="form-group">
                                                <select class="form-control form-control-lg select2"
                                                    wire:model="insurance_coverage.level"
                                                    wire:change="updatePolicyDropdown()">
                                                ...
                                                @error('insurance_coverage.level')
                                                    <span class="error">Level is required</span>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                <select class="form-control form-control-lg select2"
                                                ...
                                                @error('insurance_coverage.policy')
                                                    <span class="error">Policy is required</span>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                <input class="form-control form-control-lg" type="text"
                                                    wire:model="insurance_coverage.cover"
                                                    placeholder="What's Covered" maxlength="20">
                                                @error('insurance_coverage.cover')
                                                    <span class="error">Cover is required</span>
                                                @enderror
                                            </div>
                                            <div class="form-group" wire:ignore x-data="{
                                                initSummernote: function() {
                                                ...
                                                <textarea class="form-control form-control-lg" wire:model="insurance_coverage.cover_descr"
                                                    id="whats_covered_descr" type="text" placeholder="What's Covered Description" maxlength="255">{{ isset($insurance_coverage['cover_descr']) ? $insurance_coverage['cover_descr'] : '' }}</textarea>
                                                @error('insurance_coverage.cover_descr')
                                                    <span class="error">Cover Description is required</span>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                <input class="form-control form-control-lg" type="text"
                                                    wire:model="insurance_coverage.daily_price"
                                                    placeholder="Daily Price  {{ settings('currency_symbol', '$') }}"
                                                    min="1" pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                    step="0.01" maxlength="20">
                                                @error('insurance_coverage.daily_price')
                                                    <span class="error">Daily price is required</span>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                <input class="form-control form-control-lg" type="text"
                                                    wire:model="insurance_coverage.excess" placeholder="Excess"
                                                    min="1" pattern="^[0-9]+(\.[0-9]{2}){0,1}$"
                                                    step="0.01" maxlength="20">
                                                @error('insurance_coverage.excess')
                                                    <span class="error">Excess is required</span>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                <select class="form-control form-control-lg select2"
                                                    wire:model="insurance_coverage.interval" placeholder="Interval">
                                                    <option value="">Select Interval</option>
                                                    <option value="daily">Daily</option>
                                                    <option value="weekly">Weekly</option>
                                                    <option value="one_time">One Time</option>
                                            ...
                                            <div class="form-group mt-3">
                                                <button type="button" wire:click.prevent="addInsuranceCoverage"
                                                    class="btn btn-lg btn-success">
                                                    Save
                                                </button>
                                            </div>
                            ...
                            @if ($step == 18)
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button
                                            class="nav-link {{ $calendarTab == 'availability' ? 'active' : '' }}"
                                            wire:click="setCalendarTab('availability')" type="button"
                                            role="tab">Availability</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link {{ $calendarTab == 'blackout' ? 'active' : '' }}"
                                            wire:click="setCalendarTab('blackout')" type="button"
                                            role="tab">Blackout</button>
                                    </li>
                                </ul>
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade {{ $calendarTab == 'availability' ? 'show active' : '' }}"
                                        role="tabpanel">
                                        <h4>Availability</h4>
                                            ...
                                            <div class="row">
                                                <div class="col-12 mb-2">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2"
                                                            id="availability.day_of_week"
                                                            wire:model="availability.day_of_week">
                                                ...
                                                <div class="col-6 mb-2" wire:ignore>
                                                    ...
                                                    <input type="text" data-type="time"
                                                        class="form-control flatpickr" placeholder="hh:mm AA"
                                                        id="pickup_hours_start"
                                                        wire:model="availability.pickup_hours_start">
                                                </div>
                                                <div class="col-6 mb-2" wire:ignore>
                                                    ...
                                                    <input type="text" data-type="time"
                                                        class="form-control flatpickr" placeholder="hh:mm AA"
                                                        id="pickup_hours_end"
                                                        wire:model="availability.pickup_hours_end">
                                                </div>
                                                <div class="col-12 mb-2">
                                                    <h6>Return Hours</h6>
                                                </div>
                                                <div class="col-6 mb-2" wire:ignore>
                                                    ...
                                                    <input type="text" data-type="time"
                                                        class="form-control flatpickr" placeholder="hh:mm AA"
                                                        id="return_hours_start"
                                                        wire:model="availability.return_hours_start">
                                                </div>
                                                <div class="col-6 mb-2" wire:ignore>
                                                    ...
                                                    <input type="text" data-type="time"
                                                        class="form-control flatpickr" placeholder="hh:mm AA"
                                                        id="return_hours_end"
                                                        wire:model="availability.return_hours_end">
                                                </div>
                                                <div class="col-12 text-center">
                                                    <button type="button" wire:click.prevent="saveAvailability"
                                                        class="btn btn-lg btn-success">
                                                        Save
                                                    </button>
                                                </div>
                                                ...
                                                <tbody>
                                                    @foreach ($availabilities as $item)
                                                        <tr>
                                                            ...
                                                            <td>{{ $item['pickup_hours_start'] }} -
                                                                {{ $item['pickup_hours_end'] }}</td>
                                                            <td>{{ $item['return_hours_start'] }} -
                                                                {{ $item['return_hours_end'] }}</td>
                                                            <td>
                                                                <button type="button"
                                                                    wire:click="removeAvailability({{ $item['id'] }})"
                                    ...
                                    <div class="tab-pane fade {{ $calendarTab == 'blackout' ? 'show active' : '' }}"
                                        role="tabpanel">
                                        <h4>Blackout</h4>
                                            ...
                                            <div class="row">
                                                <div class="col-6 mb-2" wire:ignore>
                                                    ...
                                                    <input type="text" data-type="datetime"
                                                        ...
                                                        placeholder="YYYY-MM-DD hh:mm AA" id="start_date_time"
                                                        wire:model="blackout.start_date_time">
                                                </div>
                                                <div class="col-6 mb-2" wire:ignore>
                                                    <label for="end_date_time">End Date/Time</label>
                                                    <input type="text" data-type="datetime"
                                                        class="form-control flatpickr"
                                                        placeholder="YYYY-MM-DD hh:mm AA" id="end_date_time"
                                                        wire:model="blackout.end_date_time">
                                                </div>
                                                <div class="col-6 mb-2">
                                                    <label for="reason">Reason</label>
                                                    <select class="form-control" id="reason"
                                                        wire:model="blackout.reason">
                                                ...
                                                <div class="col-6 mb-2">
                                                    ...
                                                    <select class="form-control" id="hard_block"
                                                        wire:model="blackout.hard_block">
                                                ...
                                                <div class="col-12 text-center">
                                                    <button type="button" wire:click.prevent="saveBlackout"
                                                        class="btn btn-lg btn-success">
                                                        Save
                                                    </button>
                                                </div>
                                                ...
                                                <tbody>
                                                    @foreach ($blackouts as $item)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <button type="button"
                                                                    wire:click="deleteBlackout({{ $item['id'] }})"
                                ...
                                <div class="row">
                                    ...
                                    @if (!$unlimited_mileage)
                                        <div class="col-4">
                                            <div class="form-group mb-2">
                                                ...
                                                @error('mileage_policy')
                                                    <span class="error">Mileage policy is required</span>
                                                @enderror
                                            </div>
                                        </div>
                                        @if ($mileage_policy != 'unlimited')
                                            <div class="col-4">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input class="form-control form-control-lg" min="1"
                                                        type="text" wire:model="mileage_limit"
                                                        pattern="^[0-9]+(\.[0-9]{2}){0,1}$" step="0.01"
                                                        maxlength="20">
                                                    @error('mileage_limit')
                                                        <span class="error">Mileage limit is required</span>
                                                    @enderror
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div class="form-group mb-2">
                                                    <label>Excess Mileage Rate ({{ settings('currency_symbol', '$') }}
                                                        per mile)</label>
                                                    <input class="form-control form-control-lg" type="text"
                                                        wire:model="excess_mileage_rate"
                                                        placeholder="Excess Mileage Rate"
                                                        pattern="^[0-9]+(\.[0-9]{2}){0,1}$" step="0.01"
                                                        maxlength="20">
                                                    @error('excess_mileage_rate')
                                                        <span class="error">Excess mileage rate is required</span>
                                                    @enderror
                                                </div>
                                            </div>
                                        @endif
                                    ...
                                    @if (!$free_cancellation)
                                        <div class="col-12">
                                            ...
                                            <select class="form-control form-control-lg"
                                                wire:model="cancellation_policy">
                                                <option value="">Select</option>
                                            ...
                                            @error('cancellation_policy')
                                                <span class="error">Cancellation policy is required</span>
                                            @enderror
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group mt-2">
                                            <label>Photos</label>
                                            <input type="file" wire:model="photos_input" id="photos_input"
                                                multiple class="form-control form-control-lg">
                                            @error('photos_input')
                                                <span class="error">Photos are required</span>
                                            @enderror
                                        </div>
                                    </div>
                                </div>
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="chauffer_features1_modal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    @if (count($chauffer_features1) == 0)
                                        <div class="input-group mb-2">
                                            <input type="text" class="form-control"
                                                wire:model="chauffer_features1.0" placeholder="Enter feature">
                                            <button type="button" wire:click="addChaufferFeature1"
                                                class="btn btn-outline-secondary">Add Feature</button>
                                        </div>
                                    @endif

                                    @foreach ($chauffer_features1 as $index => $term)
                                        <div class="input-group mb-2">
                                            <input type="text" class="form-control"
                                                wire:model="chauffer_features1.{{ $index }}"
                                            ...
                                            @else
                                                <button type="button"
                                                    wire:click="removeChaufferFeature1({{ $index }})"
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary"
                                        wire:click="saveChaufferFeature1()">Save</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="chauffer_features2_modal" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    @if (count($chauffer_features2) == 0)
                                        <div class="input-group mb-2">
                                            <input type="text" class="form-control"
                                                wire:model="chauffer_features2.0" placeholder="Enter feature">
                                            <button type="button" wire:click="addChaufferFeature2"
                                                class="btn btn-outline-secondary">Add Feature</button>
                                        </div>
                                    @endif

                                    @foreach ($chauffer_features2 as $index => $term)
                                        <div class="input-group mb-2">
                                            <input type="text" class="form-control"
                                                wire:model="chauffer_features2.{{ $index }}"
                                                value="{{ $term }}" placeholder="Enter feature">
                                            @if ($index == 0)
                                                <button type="button" wire:click="addChaufferFeature2"
                                                    class="btn btn-outline-secondary">Add Feature</button>
                                            @else
                                                <button type="button"
                                                    wire:click="removeChaufferFeature2({{ $index }})"
                                                    class="btn btn-outline-danger">Remove</button>
                                            @endif
                                        </div>
                                    @endforeach
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary"
                                        data-bs-dismiss="modal">Close</button>
                                    <button type="button" class="btn btn-primary"
                                        wire:click="saveChaufferFeature2()">Save</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="chauffer_addons_modal" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    @if (count($chauffer_addons) == 0)
                                        <div class="input-group mb-2">
                                            <input type="text" class="form-control"
                                                wire:model="chauffer_addons.0.name" placeholder="Enter name">
                                            <input type="price" min="0" class="form-control"
                                                wire:model="chauffer_addons.0.price" placeholder="Enter price">
                                            <button type="button" wire:click="addChaufferAddon"
                                                class="btn btn-outline-secondary">Add Addon</button>
                                        </div>
                                    @endif

                                    @foreach ($chauffer_addons as $index => $term)
                                        <div class="input-group mb-2">
                                            <input type="text" class="form-control"
                                                wire:model="chauffer_addons.{{ $index }}.name"
                                                value="{{ $term['name'] }}" placeholder="Enter name">
                                            <input type="price" min="0" class="form-control"
                                                wire:model="chauffer_addons.{{ $index }}.price"
                                                value="{{ $term['price'] }}" placeholder="Enter price">
                                            @if ($index == 0)
                                                <button type="button" wire:click="addChaufferAddon"
                                                    class="btn btn-outline-secondary">Add Addon</button>
                                            @else
                                                <button type="button"
                                                    wire:click="removeChaufferAddon({{ $index }})"
                                                    class="btn btn-outline-danger">Remove</button>
                                            @endif
                                        </div>
                                    @endforeach
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary"
                                        data-bs-dismiss="modal">Close</button>
                                    <button type="button" class="btn btn-primary"
                                        wire:click="saveChaufferAddon()">Save</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="chauffer_terms_modal" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
                                    ...
                                    <table class="table table-borderless">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="pe-0">
                                                    <input type="text" class="form-control"
                                                        wire:model="chauffer_terms.minimum_hire"
                                                        placeholder="2 hours for hourly bookings">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="pe-0">
                                                    <input type="text" class="form-control"
                                                        wire:model="chauffer_terms.overtime"
                                                        placeholder="Charged at hourly rate in 30-minute increments">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="pe-0">
                                                    <input type="text" class="form-control"
                                                        wire:model="chauffer_terms.extra_mileage"
                                                        placeholder="£2 per mile beyond included distance">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="pe-0">
                                                    <input type="text" class="form-control"
                                                        wire:model="chauffer_terms.waiting_time"
                                                        placeholder="First 30 minutes free, then £15 per 15 minutes">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="pe-0">
                                                    <input type="text" class="form-control"
                                                        wire:model="chauffer_terms.chauffeur_standards"
                                                        placeholder="Professional dress code, courteous behavior">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="pe-0">
                                                    <input type="text" class="form-control"
                                                        wire:model="chauffer_terms.vehicle_policy"
                                                        placeholder="No smoking, no pets (except service animals)">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="pe-0">
                                                    <input type="text" class="form-control"
                                                        wire:model="chauffer_terms.insurance"
                                                        placeholder="Comprehensive coverage up to £10,000,000">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="pe-0">
                                                    <input type="text" class="form-control"
                                                        wire:model="chauffer_terms.operator_compliance"
                                                        placeholder="Fully licensed and insured operator">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="pe-0">
                                                    <input type="text" class="form-control"
                                                        wire:model="chauffer_terms.cancellation"
                                                        placeholder="Free up to 24 hours before pickup, 50% charge within 24 hours">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="pe-0">
                                                    <input type="text" class="form-control"
                                                        wire:model="chauffer_terms.payment"
                                                        placeholder="50% deposit required, balance due before journey">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
