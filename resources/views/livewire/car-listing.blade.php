        ...
        <div class="hotelbooking__categoris__wrap mt-3">
            ...
            <div class="row booking-info">
                <div class="col-md-12 col-sm-12">
                    ...
                    <p>We’re sorry, but the companies we work with in {{ $location->name }} don’t have any cars
                        available.</p>
        ...
        <div class="row g-4 justify-content-center">
                ...
                <div class="common__filter__wrapper">
                    ...
                    <div class="search__item borderb pb__10 mb__20">
                        <div class="common__sidebar__head">
                            <button
                                class="w-100 fw-400 lato dtext fz-24 d-flex align-items-center justify-content-between">
                                Price per day
                        ...
                        <div class="col-12 mt-2">
                            <input wire:model.live="priceRange" type="range" class="custom-range w-100"
                                id="customRange1" min="{{ $min_price }}" max="{{ $max_price }}">
                    ...
                    @foreach ($filters as $filter => $items)
                        <div class="search__item borderb pb__10 mb__20">
                            <div class="common__sidebar__head">
                                <button
                                    class="w-100 fw-400 lato dtext fz-24 d-flex text-capitalize align-items-center justify-content-between">
                                    ...
                                    @foreach ($items as $i)
                                        <div
                                            ...
                                            <div class="radio__left d-flex align-items-center gap-2">
                                                <input wire:key="{{ $filter }}_{{ $i }}"
                                                    class="form-check-input"
                                                    wire:model.live="selected_{{ $filter }}" type="checkbox"
                                                    value="{{ $i }}" id="{{ $i }}">
            ...
            <div class="col-xxl-9 col-xl-9 col-lg-9">
                ...
                <section class="hotel__bookslider1 pb-5">
                    ...
                    @if ($total_cars > 1)
                        <div class="mb-4">
                            <h2 class="text-title">{{ $location->name }}: Over {{ $total_cars }} car(s) available in
                                this location</h2>
                        </div>
                    @endif
                    ...
                    @if ($total_booking > 0)
                        <div class="alert alert-success alert-dismissible mb-4">
                            <p>In the last 24 hours, over {{ $total_booking }} customers have booked a car in this
                                location</p>
                        </div>
                    @endif

                    <div class="mb-2">
                        <select class="form-control" wire:model.live="order_by">
                    ...
                    <div class="car_categories- d-flex-"
                        style="overflow-x: auto; gap: 10px; min-height: 120px; display: flex !important; border: 1px solid #eee; padding: 10px; margin-bottom: 15px;">
                                ...
                                <div class="car_category_item text-center {{ in_array($item->name, $selected_car_types) ? 'active' : '' }}"
                                    ...
                                    @if (!empty($item->icon))
                                        <img src="{{ $item->icon }}" alt="{{ $item->name }}"
                                            style="max-height: 60px; display: inline-block !important;"
                                    ...
                                    @else
                                        <div
                                            style="height: 60px; display: flex !important; align-items: center; justify-content: center; background-color: #f8f9fa; border-radius: 5px;">
                    ...
                    @if (count($selected_car_types) > 0)
                        <div class="text-center mt-3">
                            <button class="btn btn-sm btn-outline-primary"
                                wire:click="$set('selected_car_types', [])">Clear Vehicle Type Filter</button>
                        </div>
                    @endif
                </section>
                        ...
                        @foreach ($filteredCars as $car)
                            <div class="col-sm-12 col-md-12">
                                @include('frontpage.partials.car_item', [
                                    ...
                                    'is_highlighted' =>
                                        count($selected_car_types) > 0 &&
                                        in_array($car->type, $selected_car_types),
                                ])
                            </div>
                        @endforeach
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show"
                                ...
                                <div class="accordion-body">
                                    ...
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias amet animi
                                        architecto asperiores autem dolores doloribus, eius, esse laborum magnam maxime
                                        minus nihil obcaecati omnis possimus qui quibusdam tempora voluptatem.</p>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias amet animi
                                        architecto asperiores autem dolores doloribus, eius, esse laborum magnam maxime
                                        minus nihil obcaecati omnis possimus qui quibusdam tempora voluptatem.</p>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias amet animi
