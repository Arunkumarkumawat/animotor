...
<body>
    <div class="container">
        <!-- Insurance Panel -->
        <form method="post" action="{{ route('admin.insurance-coverages.store') }}" enctype="multipart/form-data" class="insurance-panel" id="fullProtectionPanel">
            @csrf
            ...
            <div class="panel-content">
                ...
                <div class="section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" placeholder="e.g., FP-2025-000123" value="{{ old('policy_number') }}" name="policy_number" required>
                            @error('policy_number')
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-checkbox-group">
                                ...
                                <label class="form-checkbox">
                                    <input type="checkbox" name="vehicle_classes[]" value="ev">
                                    EV / Hybrid
                                </label><br>
                                <label class="form-checkbox">
                    ...
                    <div class="coverage-grid">
                        ...
                        <div class="coverage-card">
                            ...
                            <div class="partial-notes">
                                <input type="text" class="form-input" name="coverage_matrix[0][partial_notes]" placeholder="Notes for partial coverage...">
                            </div>
                        </div>
                        ...
                        <div class="coverage-card">
                            ...
                            <div class="partial-notes">
                                <input type="text" class="form-input" name="coverage_matrix[1][partial_notes]" placeholder="Keys must not be left inside vehicle">
                            </div>
                        </div>
                        ...
                        <div class="coverage-card">
                            ...
                            <div class="partial-notes">
                                <input type="text" class="form-input" name="coverage_matrix[2][partial_notes]" placeholder="Chips & cracks fully covered">
                            </div>
                        </div>
                        ...
                        <div class="coverage-card">
                            ...
                            <div class="partial-notes">
                                <input type="text" class="form-input" name="coverage_matrix[3][partial_notes]" placeholder="Punctures and blowouts covered">
                            </div>
                        </div>
                        ...
                        <div class="coverage-card">
                            ...
                            <div class="partial-notes">
                                <input type="text" class="form-input" name="coverage_matrix[4][partial_notes]" placeholder="Cosmetic scratches excluded">
                            </div>
                        </div>
                        ...
                        <div class="coverage-card">
                            ...
                            <div class="partial-notes">
                                <input type="text" class="form-input" name="coverage_matrix[5][partial_notes]" placeholder="Replacement up to £300">
                            </div>
                        </div>
                        ...
                        <div class="coverage-card">
                            ...
                            <div class="partial-notes">
                                <input type="text" class="form-input" name="coverage_matrix[6][partial_notes]" placeholder="Accidental stains covered, burns excluded">
                            </div>
                        </div>
                        ...
                        <div class="coverage-card">
                            ...
                            <div class="partial-notes">
                                <input type="text" class="form-input" name="coverage_matrix[7][partial_notes]" placeholder="Negligent damage excluded">
                            </div>
                        </div>
                        ...
                        <div class="coverage-card">
                            ...
                            <div class="partial-notes">
                                <input type="text" class="form-input" name="coverage_matrix[8][partial_notes]" placeholder="As per Road Traffic Act">
                            </div>
                        </div>
                        ...
                        <div class="coverage-card">
                            ...
                            <div class="partial-notes">
                                <input type="text" class="form-input" name="coverage_matrix[9][partial_notes]" placeholder="All admin fees waived">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="checklist">
                        <div class="checklist-item">
                            <input type="checkbox" name="what_not_covered[]" value="Driving under influence (DUI)" id="excl1">
                            <label for="excl1">Driving under influence (DUI)</label>
                        </div>
                        <div class="checklist-item">
                            <input type="checkbox" name="what_not_covered[]" value="Off-road usage" id="excl2">
                            <label for="excl2">Off-road usage</label>
                        </div>
                        <div class="checklist-item">
                            <input type="checkbox" name="what_not_covered[]" value="Flood / water ingress" id="excl3">
                            <label for="excl3">Flood / water ingress</label>
                        </div>
                        <div class="checklist-item">
                            <input type="checkbox" name="what_not_covered[]" value="Racing, track use, drifting" id="excl4">
                            <label for="excl4">Racing, track use, drifting</label>
                        </div>
                        <div class="checklist-item">
                            <input type="checkbox" name="what_not_covered[]" value="Deliberate damage" id="excl5">
                            <label for="excl5">Deliberate damage</label>
                        </div>
                        <div class="checklist-item">
                            <input type="checkbox" name="what_not_covered[]" value="Mechanical breakdown" id="excl6">
                ...
                <div class="section">
                    ...
                    <textarea class="form-textarea" name="key_exclusions" placeholder="This Full Protection does not cover negligent driving, DUI, or unauthorised usage. Off-road use, racing, and deliberate damage are not covered. Water damage and flood-related incidents are excluded. Mechanical failures and pre-existing damage are not covered under this policy."></textarea>
                </div>
                    ...
                    <div class="financial-grid">
                        <div class="financial-field">
                            ...
                            <div class="financial-value">
                                ...
                                <input type="number" class="financial-input" name="excess_amount" value="0" min="0">
                            </div>
                            <div class="mt-2">
                        ...
                        <div class="financial-field">
                            ...
                            <div class="financial-value">
                                <span class="currency-symbol">{{ settings('currency_symbol') }}</span>
                                <input type="number" class="financial-input" name="max_claim_limit" value="0" min="0">
                            </div>
                        </div>
                        <div class="financial-field">
                            ...
                            <div class="financial-value">
                                <span class="currency-symbol">{{ settings('currency_symbol') }}</span>
                                <input type="number" class="financial-input" name="daily_rate" value="0" min="0" step="0.01">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="tab-content active" id="tab-instructions">
                        <textarea class="form-textarea" placeholder="Enter step-by-step claims instructions for customers..." name="customer_instruction" id="claim_instructions"></textarea>
                    </div>
                    ...
                    <div class="tab-content" id="tab-contact">
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-input" name="claims_contact[email]" id="claims_email" placeholder="claims@rsa.com">
                            </div>
                            <div class="form-group">
                                <label class="form-label">Claims Phone (24/7)</label>
                                <input type="tel" class="form-input" name="claims_contact[phone]" id="claims_phone" placeholder="0800 123 4567">
                            </div>
                            <div class="form-group">
                                <label class="form-label">Claims Address</label>
                                <input type="text" class="form-input" name="claims_contact[address]" id="claims_address" placeholder="RSA Claims Department, London">
                            </div>
                            <div class="form-group">
                    ...
                    <div class="tab-content" id="tab-documents">
                        <div class="checklist">
                            <div class="checklist-item">
                                <input type="checkbox" id="doc1" name="required_documents[]" value="Rental Agreement / Invoice">
                                <label for="doc1">Rental Agreement / Invoice</label>
                            </div>
                            <div class="checklist-item">
                                <input type="checkbox" id="doc2" name="required_documents[]" value="Photographs of damage (minimum 4 angles)">
                                <label for="doc2">Photographs of damage (minimum 4 angles)</label>
                            </div>
                            <div class="checklist-item">
                                <input type="checkbox" id="doc3" name="required_documents[]" value="Police report (if applicable)">
                                <label for="doc3">Police report (if applicable)</label> 
                            </div>
                            <div class="checklist-item">
                                <input type="checkbox" id="doc4" name="required_documents[]" value="Third-party details and insurance">
                                <label for="doc4">Third-party details and insurance</label>
                            </div>
                            <div class="checklist-item">
                                <input type="checkbox" id="doc5" name="required_documents[]" value="Completed incident report form">
                                <label for="doc5">Completed incident report form</label>
                            </div>
                            <div class="checklist-item">
                                <input type="checkbox" id="doc6" name="required_documents[]" value="Driver's license copy">
                                <label for="doc6">Driver's license copy</label>
                            </div>
                            <div class="checklist-item">
                                <input type="checkbox" id="doc7" name="required_documents[]" value="Repair estimates (if already obtained)">
