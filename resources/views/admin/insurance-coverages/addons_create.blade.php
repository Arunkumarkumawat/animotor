...
<body>
    <div class="container">
        ...
        <form action="{{ route('admin.insurance-coverages.store') }}" method="POST" class="insurance-panel" id="addonsPanel" enctype="multipart/form-data">
            @csrf
                ...
                <div class="section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" placeholder="e.g., OA-2025-000123" name="policy_number" value="{{ old('policy_number') }}">
                            @error('policy_number')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" placeholder="e.g., Allianz / AXA / Aviva" name="insurer_name" value="{{ old('insurer_name') }}">
                            @error('insurer_name')
                                <span class="text-red-500 text-xs mt-1">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="financial-grid">
                        <div class="financial-field">
                            ...
                            <div class="financial-value">
                                ...
                                <input type="number" class="financial-input" name="excess_amount" value="{{ old('excess_amount', 0) }}" min="0" id="excessInput">
                            </div>
                    ...
                    <div class="tab-content" id="tab-contact">
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-input" name="claims_contact[phone_roadside]" value="{{ old('claims_contact.phone_roadside', '') }}">
                            </div>
                            <div class="form-group">
