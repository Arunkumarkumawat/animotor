...
<body>
    <div class="container">
        <!-- CDW Insurance Panel -->
        <form action="{{ route('admin.insurance-coverages.store') }}" method="POST" class="insurance-panel" id="cdwPanel" enctype="multipart/form-data">
            @csrf
            ...
            <div class="panel-content">
                ...
                <div class="section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" placeholder="e.g., CDW-2025-000123" value="{{ old('policy_number') }}" name="policy_number" required>
                            @error('policy_number')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" placeholder="e.g., RSA Insurance" value="{{ old('insurer_name') }}" name="insurer_name" required>
                            @error('insurer_name')
                                <span class="text-red-500 text-xs mt-1">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="date" class="form-input" value="{{ old('policy_start_date') }}" name="policy_start_date" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-input" value="{{ old('policy_end_date') }}" name="policy_end_date" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-checkbox-group">
                                ...
                                <label class="form-checkbox">
                                    <input type="checkbox" name="vehicle_classes[]" value="suv" {{ in_array('suv', old('vehicle_classes', [])) ? 'checked' : '' }}>
                                    SUV
                                </label>
                                <label class="form-checkbox">
                                    <input type="checkbox" name="vehicle_classes[]" value="luxury" {{ in_array('luxury', old('vehicle_classes', [])) ? 'checked' : '' }}>
                                    Luxury
                                </label>
                                <label class="form-checkbox">
                                    <input type="checkbox" name="vehicle_classes[]" value="ev" {{ in_array('ev', old('vehicle_classes', [])) ? 'checked' : '' }}>
                                    EV / Hybrid
                                </label>
                                <label class="form-checkbox">
                                    <input type="checkbox" name="vehicle_classes[]" value="mpv" {{ in_array('mpv', old('vehicle_classes', [])) ? 'checked' : '' }}>
                                    MPV
                                </label>
                                <label class="form-checkbox">
                                    <input type="checkbox" name="vehicle_classes[]" value="economy" {{ in_array('economy', old('vehicle_classes', [])) ? 'checked' : '' }}>
                                    Economy
                                </label>
                            </div>
                            @error('vehicle_classes')
                    ...
                    <div class="coverage-grid">
                        ...
                        <div class="coverage-card">
                            <div class="coverage-card-header">
                                ...
                                <input type="hidden" name="coverage_matrix[0][status]" class="coverage-item-status" value="covered">
                                <div class="coverage-name">Collision Damage</div>
                                <div class="toggle-3state">
                                    <span class="toggle-option covered active" onclick="selectToggle(this, 'covered')">Covered</span>
                                    <span class="toggle-option partial" onclick="selectToggle(this, 'partial')">Partial</span>
                                    <span class="toggle-option not-covered" onclick="selectToggle(this, 'not')">Not</span>
                                </div>
                            </div>
                            <div class="partial-notes">
                                <input type="text" class="form-input" name="coverage_matrix[0][partial_notes]" placeholder="e.g., Covered subject to excess" value="{{ old('coverage_matrix.0.partial_notes') }}">
                            </div>
                        </div>
                        ...
                        <div class="coverage-card">
                            <div class="coverage-card-header">
                                ...
                                <input type="hidden" name="coverage_matrix[1][status]" class="coverage-item-status" value="covered">
                                <div class="toggle-3state">
                                    <span class="toggle-option covered active" onclick="selectToggle(this, 'covered')">Covered</span>
                                    <span class="toggle-option partial" onclick="selectToggle(this, 'partial')">Partial</span>
                                    <span class="toggle-option not-covered" onclick="selectToggle(this, 'not')">Not</span>
                            ...
                            <div class="partial-notes">
                                <input type="text" class="form-input" name="coverage_matrix[1][partial_notes]" placeholder="e.g., Covered unless negligent" value="{{ old('coverage_matrix.1.partial_notes') }}">
                            </div>
                        </div>
                        ...
                        <div class="coverage-card">
                            <div class="coverage-card-header">
                                ...
                                <input type="hidden" name="coverage_matrix[2][status]" class="coverage-item-status" value="covered">
                            ...
                            <div class="partial-notes">
                                <input type="text" class="form-input" name="coverage_matrix[2][partial_notes]" placeholder="e.g., Third-party details required" value="{{ old('coverage_matrix.2.partial_notes') }}">
                            </div>
                        </div>
                        ...
                        <div class="coverage-card">
                            <div class="coverage-card-header">
                                ...
                                <input type="hidden" name="coverage_matrix[3][status]" class="coverage-item-status" value="covered">
                            ...
                            <div class="partial-notes">
                                <input type="text" class="form-input" name="coverage_matrix[3][partial_notes]" placeholder="As per Road Traffic Act" value="{{ old('coverage_matrix.3.partial_notes') }}">
                            </div>
                        </div>
                        ...
                        <div class="coverage-card">
                            <div class="coverage-card-header">
                                ...
                                <input type="hidden" name="coverage_matrix[4][status]" class="coverage-item-status" value="covered">
                        ...
                        <div class="coverage-card">
                            <div class="coverage-card-header">
                                ...
                                <input type="hidden" name="coverage_matrix[5][status]" class="coverage-item-status" value="covered">
                            ...
                            <div class="partial-notes">
                                <input type="text" class="form-input" name="coverage_matrix[5][partial_notes]" value="{{ old('coverage_matrix.5.partial_notes') }}">
                            </div>
                        </div>
                        ...
                        <div class="coverage-card">
                            <div class="coverage-card-header">
                                ...
                                <input type="hidden" name="coverage_matrix[6][status]" class="coverage-item-status" value="covered">
                            ...
                            <div class="partial-notes">
                                <input type="text" class="form-input" name="coverage_matrix[6][partial_notes]" placeholder="Notes for partial coverage..." value="{{ old('coverage_matrix.6.partial_notes') }}">
                            </div>
                        </div>
                        ...
                        <div class="coverage-card">
                            <div class="coverage-card-header">
                                ...
                                <input type="hidden" name="coverage_matrix[7][status]" class="coverage-item-status" value="covered">
                            ...
                            <div class="partial-notes">
                                <input type="text" class="form-input" name="coverage_matrix[7][partial_notes]" placeholder="Subject to investigation" value="{{ old('coverage_matrix.7.partial_notes') }}">
                            </div>
                        </div>
                        ...
                        <div class="coverage-card">
                            <div class="coverage-card-header">
                                ...
                                <input type="hidden" name="coverage_matrix[8][status]" class="coverage-item-status" value="covered">
                            ...
                            <div class="partial-notes">
                                <input type="text" class="form-input" name="coverage_matrix[8][partial_notes]" placeholder="Police report required" value="{{ old('coverage_matrix.8.partial_notes') }}">
                            </div>
                        </div>
                        ...
                        <div class="coverage-card">
                            <div class="coverage-card-header">
                                ...
                                <input type="hidden" name="coverage_matrix[9][status]" class="coverage-item-status" value="covered">
                            ...
                            <div class="partial-notes">
                                <input type="text" class="form-input" name="coverage_matrix[9][partial_notes]" value="{{ old('coverage_matrix.9.partial_notes') }}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <textarea class="form-textarea" placeholder="CDW exclusions wording for certificates..." name="key_exclusions">{{ old('key_exclusions') }}</textarea>
                </div>
                    ...
                    <div class="financial-grid">
                        <div class="financial-field">
                            ...
                            <div class="financial-value">
                                ...
                                <input type="number" class="financial-input" name="excess_amount" min="0" id="excessInput" value="{{ old('excess_amount') }}">
                            </div>
                            @error('excess_amount')
                                <span class="text-red-500 text-xs mt-1">{{ $message }}</span>
                            @enderror
                ...
                <div class="section">
                    <div class="section-header">
                        ...
                        <div>
                            ...
                            <div class="section-hint">Upload all required CDW policy documents (PDF only)</div>
                        </div>
                    </div>
                ...
                <div class="section">
                    ...
                    <div class="tab-content active" id="tab-instructions">
                        <textarea class="form-textarea" placeholder="Enter step-by-step claims instructions for customers..." name="customer_instruction">{{ old('customer_instruction') }}</textarea>
                    </div>
                    ...
                    <div class="tab-content" id="tab-contact">
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-input" name="claims_contact[email]" placeholder="claims@rsa.com" value="{{ old('claims_contact.email') }}">
                            </div>
                            <div class="form-group">
                                <label class="form-label">Claims Phone (24/7)</label>
                                <input type="tel" class="form-input" name="claims_contact[phone]" placeholder="+44 800 123 4567" value="{{ old('claims_contact.phone') }}">
                            </div>
                            <div class="form-group">
                                <label class="form-label">Claims Address</label>
                                <input type="text" class="form-input" name="claims_contact[address]" id="claims_address" placeholder="RSA Claims Department, London" value="{{ old('claims_contact.address') }}">
                            </div>
                            <div class="form-group">
                                <label class="form-label">Claims Portal URL</label>
                                <input type="url" class="form-input" name="claims_contact[portal_url]" id="claims_portal_url" placeholder="https://claims.rsa.com">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-content" id="tab-documents">
                        ...
                        <div class="checklist">
                            <div class="checklist-item">
                                <input type="checkbox" id="doc1" name="required_documents[]" value="Rental Agreement / Invoice with CDW selected" {{ in_array('Rental Agreement / Invoice with CDW selected', $requiredDocuments) ? 'checked' : '' }}>
                                <label for="doc1">Rental Agreement / Invoice with CDW selected</label>
                            </div>
                            <div class="checklist-item">
                                <input type="checkbox" id="doc2" name="required_documents[]" value="Photographs of collision damage (minimum 6 angles)" {{ in_array('Photographs of collision damage (minimum 6 angles)', $requiredDocuments) ? 'checked' : '' }}>
                                <label for="doc2">Photographs of collision damage (minimum 6 angles)</label>
                            </div>
                            <div class="checklist-item">
                                <input type="checkbox" id="doc3" name="required_documents[]" value="Police report (mandatory for third-party accidents)" {{ in_array('Police report (mandatory for third-party accidents)', $requiredDocuments) ? 'checked' : '' }}>
                                <label for="doc3">Police report (mandatory for third-party accidents)</label>
                            </div>
                            <div class="checklist-item">
                                <input type="checkbox" id="doc4" name="required_documents[]" value="Third-party details (name, insurance, contact info)" {{ in_array('Third-party details (name, insurance, contact info)', $requiredDocuments) ? 'checked' : '' }}>
                                <label for="doc4">Third-party details (name, insurance, contact info)</label>
                            </div>
                            <div class="checklist-item">
                                <input type="checkbox" id="doc5" name="required_documents[]" value="Completed CDW incident report form" {{ in_array('Completed CDW incident report form', $requiredDocuments) ? 'checked' : '' }}>
                                <label for="doc5">Completed CDW incident report form</label>
                            </div>
                            <div class="checklist-item">
                                <input type="checkbox" id="doc6" name="required_documents[]" value="Driver's license copy (both sides)" {{ in_array("Driver's license copy (both sides)", $requiredDocuments) ? 'checked' : '' }}>
                                <label for="doc6">Driver's license copy (both sides)</label>
                            </div>
                            <div class="checklist-item">
                                <input type="checkbox" id="doc7" name="required_documents[]" value="Witness statements (if available)" {{ in_array('Witness statements (if available)', $requiredDocuments) ? 'checked' : '' }}>
                                <label for="doc7">Witness statements (if available)</label>
                            </div>
                            <div class="checklist-item">
                                <input type="checkbox" id="doc8" name="required_documents[]" value="Repair estimates (optional - we will arrange assessment)" {{ in_array('Repair estimates (optional - we will arrange assessment)', $requiredDocuments) ? 'checked' : '' }}>
