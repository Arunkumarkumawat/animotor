...
<body>
    <div class="container">
        ...
        <form action="{{ route('admin.insurance-coverages.store') }}" method="POST" class="insurance-panel" id="basicPanel" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="policy_type" value="Basic">
                            ...
                            <div class="checkbox-group @error('vehicle_classes') is-invalid @enderror">
                                <label class="checkbox-label">
                                    <input type="checkbox" name="vehicle_classes[]" value="Economy" 
                                           {{ is_array(old('vehicle_classes')) && in_array('Economy', old('vehicle_classes')) ? 'checked' : '' }}>
                                    <span class="checkmark"></span>
                                    Economy
                                </label>
                                <label class="checkbox-label">
                                    <input type="checkbox" name="vehicle_classes[]" value="Compact"
                                           {{ is_array(old('vehicle_classes')) && in_array('Compact', old('vehicle_classes')) ? 'checked' : '' }}>
                                    <span class="checkmark"></span>
                                    Compact
                                </label>
                                <label class="checkbox-label">
                                    <input type="checkbox" name="vehicle_classes[]" value="SUV"
                                           {{ is_array(old('vehicle_classes')) && in_array('SUV', old('vehicle_classes')) ? 'checked' : '' }}>
                                    <span class="checkmark"></span>
                                    SUV
                                </label>
                                <label class="checkbox-label">
                                    <input type="checkbox" name="vehicle_classes[]" value="Luxury"
                                           {{ is_array(old('vehicle_classes')) && in_array('Luxury', old('vehicle_classes')) ? 'checked' : '' }}>
                                    <span class="checkmark"></span>
                                    Luxury
                                </label>
                                <label class="checkbox-label">
                                    <input type="checkbox" name="vehicle_classes[]" value="EV / Hybrid"
                                           {{ is_array(old('vehicle_classes')) && in_array('EV / Hybrid', old('vehicle_classes')) ? 'checked' : '' }}>
                                    <span class="checkmark"></span>
                                    EV / Hybrid
                                </label>
                                <label class="checkbox-label">
                                    <input type="checkbox" name="vehicle_classes[]" value="MPV"
                                           {{ is_array(old('vehicle_classes')) && in_array('MPV', old('vehicle_classes')) ? 'checked' : '' }}>
                                    <span class="checkmark"></span>
                                    MPV
                                </label>
                            </div>
                    ...
                    <div class="coverage-grid">
                        ...
                        <div class="coverage-card">
                            ...
                            <div class="partial-notes {{ old('coverage_matrix.0.status') === 'partial' ? 'active' : '' }}"">
                                <input type="text" name="coverage_matrix[0][partial_notes]" class="form-input" placeholder="Unlimited as per Road Traffic Act" value="{{ old('coverage_matrix.0.partial_notes') }}">
                            </div>
                        </div>
                        ...
                        <div class="coverage-card">
                            ...
                            <div class="partial-notes {{ old('coverage_matrix.1.status') === 'partial' ? 'active' : '' }}">
                                <input type="text" name="coverage_matrix[1][partial_notes]" class="form-input" placeholder="Up to £1.2 million" value="{{ old('coverage_matrix.1.partial_notes') }}">
                            </div>
                        </div>
                        ...
                        <div class="coverage-card">
                            ...
                            <div class="partial-notes {{ old('coverage_matrix.2.status') === 'partial' ? 'active' : '' }}">
                                <input type="text" name="coverage_matrix[2][partial_notes]" class="form-input" placeholder="Unlimited per claim" value="{{ old('coverage_matrix.2.partial_notes') }}">
                            </div>
                        </div>
                        ...
                        <div class="coverage-card">
                            ...
                            <div class="partial-notes {{ old('coverage_matrix.3.status') == 'partial' ? 'active' : '' }}">
                                <input type="text" name="coverage_matrix[3][partial_notes]" class="form-input" placeholder="Covered with insurer approval" value="{{ old('coverage_matrix.3.partial_notes') }}">
                            </div>
                        </div>
                        ...
                        <div class="coverage-card">
                            ...
                            <div class="partial-notes {{ old('coverage_matrix.4.status') == 'partial' ? 'active' : '' }}">
                                <input type="text" name="coverage_matrix[4][partial_notes]" class="form-input" placeholder="Up to £500 per person" value="{{ old('coverage_matrix.4.partial_notes') }}">
                            </div>
                        </div>
                        ...
                        <div class="coverage-card">
                            ...
                            <div class="partial-notes {{ old('coverage_matrix.5.status') == 'partial' ? 'active' : '' }}">
                                <input type="text" name="coverage_matrix[5][partial_notes]" class="form-input" placeholder="Unlimited as per RTA" value="{{ old('coverage_matrix.5.partial_notes') }}">
                            </div>
                        </div>
                        ...
                        <div class="coverage-card">
                            ...
                            <div class="partial-notes {{ old('coverage_matrix.6.status') == 'partial' ? 'active' : '' }}">
                                <input type="text" name="coverage_matrix[6][partial_notes]" class="form-input" placeholder="All UK public roads" value="{{ old('coverage_matrix.6.partial_notes') }}">
                            </div>
                        </div>
                        ...
                        <div class="coverage-card">
                            ...
                            <div class="partial-notes  {{ old('coverage_matrix.7.status') == 'partial' ? 'active' : '' }}">
                                <input type="text" name="coverage_matrix[7][partial_notes]" class="form-input" placeholder="Green Card required" value="{{ old('coverage_matrix.7.partial_notes') }}">
                            </div>
                        </div>
                        ...
                        <div class="coverage-card">
                            ...
                            <div class="partial-notes  {{ old('coverage_matrix.8.status') == 'partial' ? 'active' : '' }}">
                                <input type="text" name="coverage_matrix[8][partial_notes]" class="form-input" placeholder="Named drivers on agreement" value="{{ old('coverage_matrix.8.partial_notes') }}">
                            </div>
                        </div>
                        ...
                        <div class="coverage-card">
                            ...
                            <div class="partial-notes {{ old('coverage_matrix.9.status') == 'partial' ? 'active' : '' }}">
                                <input type="text" name="coverage_matrix[9][partial_notes]" class="form-input" placeholder="Must be valid at rental time" value="{{ old('coverage_matrix.9.partial_notes') }}">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="financial-grid">
                        <div class="financial-field">
                            ...
                            <div class="financial-value">
                                ...
                                <input type="number" class="financial-input" id="excessInput" name="excess_amount" value="{{ old('excess_amount', 0) }}" min="0">
                            </div>
                        ...
                        <div class="financial-field">
                            ...
                            <div class="financial-value">
                                <span class="currency-symbol">{{ settings('currency_symbol') }}</span>
                                <input type="number" class="financial-input" name="max_claim_limit" value="{{ old('max_claim_limit', 0) }}" min="0">
                            </div>
                        </div>
                        <div class="financial-field">
                            ...
                            <div class="financial-value">
                                <span class="currency-symbol">{{ settings('currency_symbol') }}</span>
                                <input type="number" class="financial-input" name="daily_rate" value="{{ old('daily_rate', 0) }}" min="0" step="0.01">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="tab-content" id="tab-contact">
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-input" name="claims_contact[phone_main]" value="{{ old('claims_contact.phone_main', '') }}">
                            </div>
                            <div class="form-group">
