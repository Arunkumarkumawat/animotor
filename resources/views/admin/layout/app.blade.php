    ...
    @php
        ...
        if (hasRental()) {
            ...
            $menuArray[] = [
                ...
                'url' => route('admin.insurance-coverages.index'),
                'icon' => 'ni ni-briefcase',
                'route' => 'insurance-coverages-read',
            ];
            ...
            $menuArray[] = [
                'url' => route('admin.bookings.commissions'),
                'text' => 'Booking Commissions',
                'route' => 'bookings-index',
                'icon' => 'ni ni-coin',
            ];
...
<body class="nk-body bg-lighter- npc-general has-sidebar {{ settings('is_dark') == 'yes' ? 'dark-mode' : '' }} ">
    <div class="nk-app-root">
        ...
        <div class="nk-main ">
            <!-- sidebar @s -->
            <div class="nk-sidebar nk-sidebar-fixed is-dark  {{ settings('is_dark') == 'yes' ? 'is-dark-' : '' }}"
                ...
                <div class="nk-sidebar-element nk-sidebar-body {{isOwner() && auth()->user()->onboarding_status !='approved' ? 'd-none' : ''}}">
                                    ...
                                    @permission($menu['route'])
                                        ...
                                        @else
                                            ...
                                            <li class="nk-menu-item{{ isset($menu['submenu']) ? ' has-sub' : '' }}">
                                                {{--                                        @if ($url) --}}
                                                <a href="{{ $url }}"
                                                    {{ isset($menu['submenu']) ? '' : 'wire:navigate_' }}
                                                    class="nk-menu-link{{ isset($menu['submenu']) ? ' nk-menu-toggle' : '' }}">
                                                    @if (isset($menu['icon']))
                                                        <span class="nk-menu-icon"><em
                                                                class="icon ni {{ $menu['icon'] }}"></em></span>
                                                    @endif
                                                        ...
                                                        @foreach ($menu['submenu'] as $submenu)
                                                            @if (isset($submenu['route']))
                                                                @permission($submenu['route'])
                                                                    @php
                                                                        $submenuUrl = isset($submenu['url'])
                                                                            ? $submenu['url']
                                                                            : '#';
                                                                    @endphp
                                                                    @if ($submenuUrl)
                                                                        <li class="nk-menu-item">
                                                                            <a href="{{ $submenuUrl }}" wire:navigate_
                                                                                class="nk-menu-link">
                                                                                <span
                                                                                    class="nk-menu-text">{{ $submenu['text'] }}</span>
                                                                            </a>
                                                                        </li>
                                                                    @endif
                                                                @endpermission
                        ...
                        <div class="nk-header-wrap">
                            ...
                            <div class="nk-header-news d-none d-xl-block">
                                <div class="nk-news-list">
                                    <a class="nk-news-item" title="Open frontend" target="_blank"
                                        href="{{ url('/') }}">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-end dropdown-menu-s1">
                                            ...
                                            <div class="dropdown-inner">
                                                <ul class="link-list">
                                                    <li>
                                                        <a class="dark-switch-"
                                                            href="{{ route('admin.settings.toggle_theme') }}"><em
                                                    ...
                                                    @if (isOwner())
                                                        <li>
                                                            <a class="dropdown-item"
                                                                ...
                                                                <em class="icon ni ni-user-alt"></em><span>Company
                                                                    Profile</span>
                                                            </a>
                                                        </li>
                                                    @endif
